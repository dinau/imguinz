...
pub fn gui_main(window: *app.Window) void {
    ...
    while (!window.shouldClose ()) {
        ...
        //------------------------
        {
            ...
            const blue: spinner.ImColor = .{ .Value = .{ .x = 0.0, .y = 0.0, .z = 1.0, .w = 1.0 } };
            // See ../build.zig, if you'd like to add other spinners.
            spinner.SpinnerDnaDotsEx(       "DnaDotsV", 16, 2, red, 1.2, 8, 0.25, true); ig.igSameLine(0.0, -1.0); // Defined by "SPINNER_DNADOTS" in ../build.zig
            spinner.SpinnerRainbowMix(      "Rmix",     16, 2, blue, 2);                     ig.igSameLine(0.0, -1.0);
