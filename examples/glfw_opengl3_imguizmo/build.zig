...
pub fn build(b: *std.Build) void {
    ...
    // imguizmo module
    // ----------------
    const imguizmo_step = b.addTranslateC(.{
        .root_source_file = b.path("../../libs/cimguizmo/cimguizmo.h"),
        .target = target,
        .optimize = optimize,
        .link_libc = true,
    });
    imguizmo_step.defineCMacro("CIMGUI_DEFINE_ENUMS_AND_STRUCTS", "");
    imguizmo_step.addIncludePath(b.path("../../libs/cimgui"));
    const imguizmo_mod = imguizmo_step.createModule();
    imguizmo_mod.addCMacro("imguizmo_NAMESPACE", "imguizmo");
    imguizmo_mod.addCSourceFiles(.{ .files = &.{
        "../../libs/cimguizmo/cimguizmo.cpp",
        "../../libs/cimguizmo/ImGuizmo/GraphEditor.cpp",
        "../../libs/cimguizmo/ImGuizmo/ImCurveEdit.cpp",
        "../../libs/cimguizmo/ImGuizmo/ImGradient.cpp",
        "../../libs/cimguizmo/ImGuizmo/ImGuizmo.cpp",
        "../../libs/cimguizmo/ImGuizmo/ImSequencer.cpp",
    } });
    imguizmo_mod.addIncludePath(b.path("../../libs/cimgui"));
    imguizmo_mod.addIncludePath(b.path("../../libs/cimgui/imgui"));
    exe_mod.addImport("imguizmo", imguizmo_mod);
    ...
    const resBin = [_][]const u8{ "imgui.ini", "glfw_opengl3_imguizmo.ini" };
