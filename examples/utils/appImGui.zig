...
pub const Window = struct {
    ...
    pub fn createImGui(w: i32, h: i32, title: [*c]const u8) !Window {
        ...
        //-------------------------------------
        _ = impl.ImGui_ImplGlfw_InitForOpenGL(@ptrCast(win.handle), true);
        _ = impl.ImGui_ImplOpenGL3_Init(glsl_version.ptr);
    ...
    pub fn render(win: *Window) void {
        ...
        impl.ImGui_ImplOpenGL3_RenderDrawData(ig.igGetDrawData());
        // Docking featrue --- N/A
        if (IMGUI_HAS_DOCK) {
    ...
    pub fn frame(win: Window) void {
        ...
        _ = win;
        impl.ImGui_ImplOpenGL3_NewFrame();
        impl.ImGui_ImplGlfw_NewFrame();
        ig.igNewFrame();
    }
    ...
    pub fn destroyImGui(win: *Window) void {
        ...
        impl.ImGui_ImplOpenGL3_Shutdown();
        impl.ImGui_ImplGlfw_Shutdown();
