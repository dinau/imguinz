...
pub fn build(b: *std.Build) void {
    ...
    imnodes_step.defineCMacro("CIMGUI_DEFINE_ENUMS_AND_STRUCTS", "");
    imnodes_step.addIncludePath(b.path("../../libs/cimgui"));
    const imnodes_mod = imnodes_step.createModule();
    imnodes_mod.addCMacro("IMNODES_NAMESPACE", "imnodes");
    imnodes_mod.addCSourceFiles(.{
        .files = &.{
            "../../libs/cimnodes/cimnodes.cpp",
            "../../libs/cimnodes/imnodes/imnodes.cpp",
        },
        .flags = &.{
            "-O2",
        },
    });
    imnodes_mod.addIncludePath(b.path("../../libs/cimgui"));
    imnodes_mod.addIncludePath(b.path("../../libs/cimgui/imgui"));
    exe_mod.addImport("imnodes", imnodes_mod);
