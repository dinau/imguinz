...
// C:\imguinz\examples\glfw_opengl3_implot3d\../../src/libzig/implot3d\..\..\libc\cimgui/cimgui.h:1569:18: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_implot3d\../../src/libzig/implot3d\..\..\libc\cimgui/cimgui.h:1652:18: warning: struct demoted to opaque type - has bitfield
...
pub const struct_ImFontConfig = extern struct {
    ...
    ExtraSizeScale: f32 = @import("std").mem.zeroes(f32),
...
// C:\imguinz\examples\glfw_opengl3_implot3d\../../src/libzig/implot3d\..\..\libc\cimgui/cimgui.h:3777:9: warning: struct demoted to opaque type - has bitfield
...
pub const struct_ImGuiStyle = extern struct {
    ...
    ImageRounding: f32 = @import("std").mem.zeroes(f32),
    ...
    ColorMarkerSize: f32 = @import("std").mem.zeroes(f32),
...
// C:\imguinz\examples\glfw_opengl3_implot3d\../../src/libzig/implot3d\..\..\libc\cimgui/cimgui.h:3403:29: warning: struct demoted to opaque type - has bitfield
...
pub const struct_ImGuiNextItemData = extern struct {
    ...
    ColorMarker: ImU32 = @import("std").mem.zeroes(ImU32),
};
...
// C:\imguinz\examples\glfw_opengl3_implot3d\../../src/libzig/implot3d\..\..\libc\cimgui/cimgui.h:3568:10: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_implot3d\../../src/libzig/implot3d\..\..\libc\cimgui/cimgui.h:3631:24: warning: struct demoted to opaque type - has bitfield
...
pub const struct_ImGuiTabBar = extern struct {
    ...
    NextScrollToTabId: ImGuiID = @import("std").mem.zeroes(ImGuiID),
...
// C:\imguinz\examples\glfw_opengl3_implot3d\../../src/libzig/implot3d\..\..\libc\cimgui/cimgui.h:2591:19: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_implot3d\../../src/libzig/implot3d\..\..\libc\cimgui/cimgui.h:2694:24: warning: struct demoted to opaque type - has bitfield
...
pub const struct_ImGuiContext = extern struct {
    ...
    ConfigNavEnableTabbing: bool = @import("std").mem.zeroes(bool),
...
pub const struct_ImGuiInputTextCallbackData = extern struct {
    ...
    EventActivated: bool = @import("std").mem.zeroes(bool),
...
// C:\imguinz\examples\glfw_opengl3_implot3d\../../src/libzig/implot3d\..\..\libc\cimgui/cimgui.h:1937:11: warning: struct demoted to opaque type - has bitfield
...
pub const struct_ImGuiWindowTempData = extern struct {
    ...
    ItemWidthDefault: f32 = @import("std").mem.zeroes(f32),
...
// C:\imguinz\examples\glfw_opengl3_implot3d\../../src/libzig/implot3d\..\..\libc\cimgui/cimgui.h:3749:10: warning: struct demoted to opaque type - has bitfield
...
pub const struct_ImPlot3DContext = opaque {};
pub const ImPlot3DContext = struct_ImPlot3DContext;
pub const ImPlot3DColormap = c_int;
pub const struct_ImPlot3DStyle = extern struct {
    ...
    Colors: [15]ImVec4 = @import("std").mem.zeroes([15]ImVec4),
    Colormap: ImPlot3DColormap = @import("std").mem.zeroes(ImPlot3DColormap),
};
pub const ImPlot3DStyle = struct_ImPlot3DStyle;
pub const struct_ImPlot3DPoint = extern struct {
    x: f32 = @import("std").mem.zeroes(f32),
    y: f32 = @import("std").mem.zeroes(f32),
    z: f32 = @import("std").mem.zeroes(f32),
};
pub const ImPlot3DPoint = struct_ImPlot3DPoint;
pub const struct_ImPlot3DRay = extern struct {
    Origin: ImPlot3DPoint = @import("std").mem.zeroes(ImPlot3DPoint),
    Direction: ImPlot3DPoint = @import("std").mem.zeroes(ImPlot3DPoint),
};
pub const ImPlot3DRay = struct_ImPlot3DRay;
pub const struct_ImPlot3DPlane = extern struct {
    Point: ImPlot3DPoint = @import("std").mem.zeroes(ImPlot3DPoint),
    Normal: ImPlot3DPoint = @import("std").mem.zeroes(ImPlot3DPoint),
};
pub const ImPlot3DPlane = struct_ImPlot3DPlane;
pub const struct_ImPlot3DBox = extern struct {
    Min: ImPlot3DPoint = @import("std").mem.zeroes(ImPlot3DPoint),
    Max: ImPlot3DPoint = @import("std").mem.zeroes(ImPlot3DPoint),
};
pub const ImPlot3DBox = struct_ImPlot3DBox;
pub const struct_ImPlot3DRange = extern struct {
    Min: f32 = @import("std").mem.zeroes(f32),
    Max: f32 = @import("std").mem.zeroes(f32),
};
pub const ImPlot3DRange = struct_ImPlot3DRange;
pub const struct_ImPlot3DQuat = extern struct {
    x: f32 = @import("std").mem.zeroes(f32),
    y: f32 = @import("std").mem.zeroes(f32),
    z: f32 = @import("std").mem.zeroes(f32),
    w: f32 = @import("std").mem.zeroes(f32),
};
pub const ImPlot3DQuat = struct_ImPlot3DQuat;
pub const ImPlot3DCond = c_int;
pub const ImPlot3DCol = c_int;
pub const ImPlot3DStyleVar = c_int;
pub const ImPlot3DMarker = c_int;
pub const ImPlot3DLocation = c_int;
pub const ImAxis3D = c_int;
pub const ImPlane3D = c_int;
pub const ImPlot3DFlags = c_int;
pub const ImPlot3DItemFlags = c_int;
pub const ImPlot3DScatterFlags = c_int;
pub const ImPlot3DLineFlags = c_int;
pub const ImPlot3DTriangleFlags = c_int;
pub const ImPlot3DQuadFlags = c_int;
pub const ImPlot3DSurfaceFlags = c_int;
pub const ImPlot3DMeshFlags = c_int;
pub const ImPlot3DImageFlags = c_int;
pub const ImPlot3DLegendFlags = c_int;
pub const ImPlot3DAxisFlags = c_int;
pub const ImPlot3DFlags_None: c_int = 0;
pub const ImPlot3DFlags_NoTitle: c_int = 1;
pub const ImPlot3DFlags_NoLegend: c_int = 2;
pub const ImPlot3DFlags_NoMouseText: c_int = 4;
pub const ImPlot3DFlags_NoClip: c_int = 8;
pub const ImPlot3DFlags_NoMenus: c_int = 16;
pub const ImPlot3DFlags_CanvasOnly: c_int = 7;
pub const ImPlot3DFlags_ = c_uint;
pub const ImPlot3DCond_None: c_int = 0;
pub const ImPlot3DCond_Always: c_int = 1;
pub const ImPlot3DCond_Once: c_int = 2;
pub const ImPlot3DCond_ = c_uint;
pub const ImPlot3DCol_Line: c_int = 0;
pub const ImPlot3DCol_Fill: c_int = 1;
pub const ImPlot3DCol_MarkerOutline: c_int = 2;
pub const ImPlot3DCol_MarkerFill: c_int = 3;
pub const ImPlot3DCol_TitleText: c_int = 4;
pub const ImPlot3DCol_InlayText: c_int = 5;
pub const ImPlot3DCol_FrameBg: c_int = 6;
pub const ImPlot3DCol_PlotBg: c_int = 7;
pub const ImPlot3DCol_PlotBorder: c_int = 8;
pub const ImPlot3DCol_LegendBg: c_int = 9;
pub const ImPlot3DCol_LegendBorder: c_int = 10;
pub const ImPlot3DCol_LegendText: c_int = 11;
pub const ImPlot3DCol_AxisText: c_int = 12;
pub const ImPlot3DCol_AxisGrid: c_int = 13;
pub const ImPlot3DCol_AxisTick: c_int = 14;
pub const ImPlot3DCol_COUNT: c_int = 15;
pub const ImPlot3DCol_ = c_uint;
pub const ImPlot3DStyleVar_LineWeight: c_int = 0;
pub const ImPlot3DStyleVar_Marker: c_int = 1;
pub const ImPlot3DStyleVar_MarkerSize: c_int = 2;
pub const ImPlot3DStyleVar_MarkerWeight: c_int = 3;
pub const ImPlot3DStyleVar_FillAlpha: c_int = 4;
pub const ImPlot3DStyleVar_PlotDefaultSize: c_int = 5;
pub const ImPlot3DStyleVar_PlotMinSize: c_int = 6;
pub const ImPlot3DStyleVar_PlotPadding: c_int = 7;
pub const ImPlot3DStyleVar_LabelPadding: c_int = 8;
pub const ImPlot3DStyleVar_LegendPadding: c_int = 9;
pub const ImPlot3DStyleVar_LegendInnerPadding: c_int = 10;
pub const ImPlot3DStyleVar_LegendSpacing: c_int = 11;
pub const ImPlot3DStyleVar_COUNT: c_int = 12;
pub const ImPlot3DStyleVar_ = c_uint;
pub const ImPlot3DMarker_None: c_int = -1;
pub const ImPlot3DMarker_Circle: c_int = 0;
pub const ImPlot3DMarker_Square: c_int = 1;
pub const ImPlot3DMarker_Diamond: c_int = 2;
pub const ImPlot3DMarker_Up: c_int = 3;
pub const ImPlot3DMarker_Down: c_int = 4;
pub const ImPlot3DMarker_Left: c_int = 5;
pub const ImPlot3DMarker_Right: c_int = 6;
pub const ImPlot3DMarker_Cross: c_int = 7;
pub const ImPlot3DMarker_Plus: c_int = 8;
pub const ImPlot3DMarker_Asterisk: c_int = 9;
pub const ImPlot3DMarker_COUNT: c_int = 10;
pub const ImPlot3DMarker_ = c_int;
pub const ImPlot3DItemFlags_None: c_int = 0;
pub const ImPlot3DItemFlags_NoLegend: c_int = 1;
pub const ImPlot3DItemFlags_NoFit: c_int = 2;
pub const ImPlot3DItemFlags_ = c_uint;
pub const ImPlot3DScatterFlags_None: c_int = 0;
pub const ImPlot3DScatterFlags_NoLegend: c_int = 1;
pub const ImPlot3DScatterFlags_NoFit: c_int = 2;
pub const ImPlot3DScatterFlags_ = c_uint;
pub const ImPlot3DLineFlags_None: c_int = 0;
pub const ImPlot3DLineFlags_NoLegend: c_int = 1;
pub const ImPlot3DLineFlags_NoFit: c_int = 2;
pub const ImPlot3DLineFlags_Segments: c_int = 1024;
pub const ImPlot3DLineFlags_Loop: c_int = 2048;
pub const ImPlot3DLineFlags_SkipNaN: c_int = 4096;
pub const ImPlot3DLineFlags_ = c_uint;
pub const ImPlot3DTriangleFlags_None: c_int = 0;
pub const ImPlot3DTriangleFlags_NoLegend: c_int = 1;
pub const ImPlot3DTriangleFlags_NoFit: c_int = 2;
pub const ImPlot3DTriangleFlags_NoLines: c_int = 1024;
pub const ImPlot3DTriangleFlags_NoFill: c_int = 2048;
pub const ImPlot3DTriangleFlags_NoMarkers: c_int = 4096;
pub const ImPlot3DTriangleFlags_ = c_uint;
pub const ImPlot3DQuadFlags_None: c_int = 0;
pub const ImPlot3DQuadFlags_NoLegend: c_int = 1;
pub const ImPlot3DQuadFlags_NoFit: c_int = 2;
pub const ImPlot3DQuadFlags_NoLines: c_int = 1024;
pub const ImPlot3DQuadFlags_NoFill: c_int = 2048;
pub const ImPlot3DQuadFlags_NoMarkers: c_int = 4096;
pub const ImPlot3DQuadFlags_ = c_uint;
pub const ImPlot3DSurfaceFlags_None: c_int = 0;
pub const ImPlot3DSurfaceFlags_NoLegend: c_int = 1;
pub const ImPlot3DSurfaceFlags_NoFit: c_int = 2;
pub const ImPlot3DSurfaceFlags_NoLines: c_int = 1024;
pub const ImPlot3DSurfaceFlags_NoFill: c_int = 2048;
pub const ImPlot3DSurfaceFlags_NoMarkers: c_int = 4096;
pub const ImPlot3DSurfaceFlags_ = c_uint;
pub const ImPlot3DMeshFlags_None: c_int = 0;
pub const ImPlot3DMeshFlags_NoLegend: c_int = 1;
pub const ImPlot3DMeshFlags_NoFit: c_int = 2;
pub const ImPlot3DMeshFlags_NoLines: c_int = 1024;
pub const ImPlot3DMeshFlags_NoFill: c_int = 2048;
pub const ImPlot3DMeshFlags_NoMarkers: c_int = 4096;
pub const ImPlot3DMeshFlags_ = c_uint;
pub const ImPlot3DImageFlags_None: c_int = 0;
pub const ImPlot3DImageFlags_NoLegend: c_int = 1;
pub const ImPlot3DImageFlags_NoFit: c_int = 2;
pub const ImPlot3DImageFlags_ = c_uint;
pub const ImPlot3DLegendFlags_None: c_int = 0;
pub const ImPlot3DLegendFlags_NoButtons: c_int = 1;
pub const ImPlot3DLegendFlags_NoHighlightItem: c_int = 2;
pub const ImPlot3DLegendFlags_Horizontal: c_int = 4;
pub const ImPlot3DLegendFlags_ = c_uint;
pub const ImPlot3DLocation_Center: c_int = 0;
pub const ImPlot3DLocation_North: c_int = 1;
pub const ImPlot3DLocation_South: c_int = 2;
pub const ImPlot3DLocation_West: c_int = 4;
pub const ImPlot3DLocation_East: c_int = 8;
pub const ImPlot3DLocation_NorthWest: c_int = 5;
pub const ImPlot3DLocation_NorthEast: c_int = 9;
pub const ImPlot3DLocation_SouthWest: c_int = 6;
pub const ImPlot3DLocation_SouthEast: c_int = 10;
pub const ImPlot3DLocation_ = c_uint;
pub const ImPlot3DAxisFlags_None: c_int = 0;
pub const ImPlot3DAxisFlags_NoLabel: c_int = 1;
pub const ImPlot3DAxisFlags_NoGridLines: c_int = 2;
pub const ImPlot3DAxisFlags_NoTickMarks: c_int = 4;
pub const ImPlot3DAxisFlags_NoTickLabels: c_int = 8;
pub const ImPlot3DAxisFlags_LockMin: c_int = 16;
pub const ImPlot3DAxisFlags_LockMax: c_int = 32;
pub const ImPlot3DAxisFlags_AutoFit: c_int = 64;
pub const ImPlot3DAxisFlags_Invert: c_int = 128;
pub const ImPlot3DAxisFlags_PanStretch: c_int = 256;
pub const ImPlot3DAxisFlags_Lock: c_int = 48;
pub const ImPlot3DAxisFlags_NoDecorations: c_int = 11;
pub const ImPlot3DAxisFlags_ = c_uint;
pub const ImAxis3D_X: c_int = 0;
pub const ImAxis3D_Y: c_int = 1;
pub const ImAxis3D_Z: c_int = 2;
pub const ImAxis3D_COUNT: c_int = 3;
pub const ImAxis3D_ = c_uint;
pub const ImPlane3D_YZ: c_int = 0;
pub const ImPlane3D_XZ: c_int = 1;
pub const ImPlane3D_XY: c_int = 2;
pub const ImPlane3D_COUNT: c_int = 3;
pub const ImPlane3D_ = c_uint;
pub const ImPlot3DColormap_Deep: c_int = 0;
pub const ImPlot3DColormap_Dark: c_int = 1;
pub const ImPlot3DColormap_Pastel: c_int = 2;
pub const ImPlot3DColormap_Paired: c_int = 3;
pub const ImPlot3DColormap_Viridis: c_int = 4;
pub const ImPlot3DColormap_Plasma: c_int = 5;
pub const ImPlot3DColormap_Hot: c_int = 6;
pub const ImPlot3DColormap_Cool: c_int = 7;
pub const ImPlot3DColormap_Pink: c_int = 8;
pub const ImPlot3DColormap_Jet: c_int = 9;
pub const ImPlot3DColormap_Twilight: c_int = 10;
pub const ImPlot3DColormap_RdBu: c_int = 11;
pub const ImPlot3DColormap_BrBG: c_int = 12;
pub const ImPlot3DColormap_PiYG: c_int = 13;
pub const ImPlot3DColormap_Spectral: c_int = 14;
pub const ImPlot3DColormap_Greys: c_int = 15;
pub const ImPlot3DColormap_ = c_uint;
pub const ImPlot3DFormatter = ?*const fn (f32, [*c]u8, c_int, ?*anyopaque) callconv(.c) c_int;
pub const CUBE_VTX_COUNT: c_int = 8;
pub const CUBE_IDX_COUNT: c_int = 36;
pub extern var cube_vtx: [8]ImPlot3DPoint;
pub extern var cube_idx: [36]c_uint;
pub const SPHERE_VTX_COUNT: c_int = 162;
pub const SPHERE_IDX_COUNT: c_int = 960;
pub extern var sphere_vtx: [162]ImPlot3DPoint;
pub extern var sphere_idx: [960]c_uint;
pub const DUCK_VTX_COUNT: c_int = 254;
pub const DUCK_IDX_COUNT: c_int = 1428;
pub extern var duck_vtx: [254]ImPlot3DPoint;
pub extern var duck_idx: [1428]c_uint;
pub extern fn ImPlot3D_CreateContext() ?*ImPlot3DContext;
pub extern fn ImPlot3D_DestroyContext(ctx: ?*ImPlot3DContext) void;
pub extern fn ImPlot3D_GetCurrentContext() ?*ImPlot3DContext;
pub extern fn ImPlot3D_SetCurrentContext(ctx: ?*ImPlot3DContext) void;
pub extern fn ImPlot3D_BeginPlot(title_id: [*c]const u8, size: ImVec2, flags: ImPlot3DFlags) bool;
pub extern fn ImPlot3D_EndPlot() void;
pub extern fn ImPlot3D_SetupAxis(axis: ImAxis3D, label: [*c]const u8, flags: ImPlot3DAxisFlags) void;
pub extern fn ImPlot3D_SetupAxisLimits(axis: ImAxis3D, v_min: f64, v_max: f64, cond: ImPlot3DCond) void;
pub extern fn ImPlot3D_SetupAxisFormat(axis: ImAxis3D, formatter: ImPlot3DFormatter, data: ?*anyopaque) void;
pub extern fn ImPlot3D_SetupAxisTicks_doublePtr(axis: ImAxis3D, values: [*c]const f64, n_ticks: c_int, labels: [*c]const [*c]const u8, keep_default: bool) void;
pub extern fn ImPlot3D_SetupAxisTicks_double(axis: ImAxis3D, v_min: f64, v_max: f64, n_ticks: c_int, labels: [*c]const [*c]const u8, keep_default: bool) void;
pub extern fn ImPlot3D_SetupAxisLimitsConstraints(axis: ImAxis3D, v_min: f64, v_max: f64) void;
pub extern fn ImPlot3D_SetupAxisZoomConstraints(axis: ImAxis3D, z_min: f64, z_max: f64) void;
pub extern fn ImPlot3D_SetupAxes(x_label: [*c]const u8, y_label: [*c]const u8, z_label: [*c]const u8, x_flags: ImPlot3DAxisFlags, y_flags: ImPlot3DAxisFlags, z_flags: ImPlot3DAxisFlags) void;
pub extern fn ImPlot3D_SetupAxesLimits(x_min: f64, x_max: f64, y_min: f64, y_max: f64, z_min: f64, z_max: f64, cond: ImPlot3DCond) void;
pub extern fn ImPlot3D_SetupBoxRotation_Float(elevation: f32, azimuth: f32, animate: bool, cond: ImPlot3DCond) void;
pub extern fn ImPlot3D_SetupBoxRotation_Plot3DQuat(rotation: ImPlot3DQuat, animate: bool, cond: ImPlot3DCond) void;
pub extern fn ImPlot3D_SetupBoxInitialRotation_Float(elevation: f32, azimuth: f32) void;
pub extern fn ImPlot3D_SetupBoxInitialRotation_Plot3DQuat(rotation: ImPlot3DQuat) void;
pub extern fn ImPlot3D_SetupBoxScale(x: f32, y: f32, z: f32) void;
pub extern fn ImPlot3D_SetupLegend(location: ImPlot3DLocation, flags: ImPlot3DLegendFlags) void;
pub extern fn ImPlot3D_PlotScatter_FloatPtr(label_id: [*c]const u8, xs: [*c]const f32, ys: [*c]const f32, zs: [*c]const f32, count: c_int, flags: ImPlot3DScatterFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotScatter_doublePtr(label_id: [*c]const u8, xs: [*c]const f64, ys: [*c]const f64, zs: [*c]const f64, count: c_int, flags: ImPlot3DScatterFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotScatter_S8Ptr(label_id: [*c]const u8, xs: [*c]const ImS8, ys: [*c]const ImS8, zs: [*c]const ImS8, count: c_int, flags: ImPlot3DScatterFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotScatter_U8Ptr(label_id: [*c]const u8, xs: [*c]const ImU8, ys: [*c]const ImU8, zs: [*c]const ImU8, count: c_int, flags: ImPlot3DScatterFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotScatter_S16Ptr(label_id: [*c]const u8, xs: [*c]const ImS16, ys: [*c]const ImS16, zs: [*c]const ImS16, count: c_int, flags: ImPlot3DScatterFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotScatter_U16Ptr(label_id: [*c]const u8, xs: [*c]const ImU16, ys: [*c]const ImU16, zs: [*c]const ImU16, count: c_int, flags: ImPlot3DScatterFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotScatter_S32Ptr(label_id: [*c]const u8, xs: [*c]const ImS32, ys: [*c]const ImS32, zs: [*c]const ImS32, count: c_int, flags: ImPlot3DScatterFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotScatter_U32Ptr(label_id: [*c]const u8, xs: [*c]const ImU32, ys: [*c]const ImU32, zs: [*c]const ImU32, count: c_int, flags: ImPlot3DScatterFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotScatter_S64Ptr(label_id: [*c]const u8, xs: [*c]const ImS64, ys: [*c]const ImS64, zs: [*c]const ImS64, count: c_int, flags: ImPlot3DScatterFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotScatter_U64Ptr(label_id: [*c]const u8, xs: [*c]const ImU64, ys: [*c]const ImU64, zs: [*c]const ImU64, count: c_int, flags: ImPlot3DScatterFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotLine_FloatPtr(label_id: [*c]const u8, xs: [*c]const f32, ys: [*c]const f32, zs: [*c]const f32, count: c_int, flags: ImPlot3DLineFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotLine_doublePtr(label_id: [*c]const u8, xs: [*c]const f64, ys: [*c]const f64, zs: [*c]const f64, count: c_int, flags: ImPlot3DLineFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotLine_S8Ptr(label_id: [*c]const u8, xs: [*c]const ImS8, ys: [*c]const ImS8, zs: [*c]const ImS8, count: c_int, flags: ImPlot3DLineFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotLine_U8Ptr(label_id: [*c]const u8, xs: [*c]const ImU8, ys: [*c]const ImU8, zs: [*c]const ImU8, count: c_int, flags: ImPlot3DLineFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotLine_S16Ptr(label_id: [*c]const u8, xs: [*c]const ImS16, ys: [*c]const ImS16, zs: [*c]const ImS16, count: c_int, flags: ImPlot3DLineFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotLine_U16Ptr(label_id: [*c]const u8, xs: [*c]const ImU16, ys: [*c]const ImU16, zs: [*c]const ImU16, count: c_int, flags: ImPlot3DLineFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotLine_S32Ptr(label_id: [*c]const u8, xs: [*c]const ImS32, ys: [*c]const ImS32, zs: [*c]const ImS32, count: c_int, flags: ImPlot3DLineFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotLine_U32Ptr(label_id: [*c]const u8, xs: [*c]const ImU32, ys: [*c]const ImU32, zs: [*c]const ImU32, count: c_int, flags: ImPlot3DLineFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotLine_S64Ptr(label_id: [*c]const u8, xs: [*c]const ImS64, ys: [*c]const ImS64, zs: [*c]const ImS64, count: c_int, flags: ImPlot3DLineFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotLine_U64Ptr(label_id: [*c]const u8, xs: [*c]const ImU64, ys: [*c]const ImU64, zs: [*c]const ImU64, count: c_int, flags: ImPlot3DLineFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotTriangle_FloatPtr(label_id: [*c]const u8, xs: [*c]const f32, ys: [*c]const f32, zs: [*c]const f32, count: c_int, flags: ImPlot3DTriangleFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotTriangle_doublePtr(label_id: [*c]const u8, xs: [*c]const f64, ys: [*c]const f64, zs: [*c]const f64, count: c_int, flags: ImPlot3DTriangleFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotTriangle_S8Ptr(label_id: [*c]const u8, xs: [*c]const ImS8, ys: [*c]const ImS8, zs: [*c]const ImS8, count: c_int, flags: ImPlot3DTriangleFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotTriangle_U8Ptr(label_id: [*c]const u8, xs: [*c]const ImU8, ys: [*c]const ImU8, zs: [*c]const ImU8, count: c_int, flags: ImPlot3DTriangleFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotTriangle_S16Ptr(label_id: [*c]const u8, xs: [*c]const ImS16, ys: [*c]const ImS16, zs: [*c]const ImS16, count: c_int, flags: ImPlot3DTriangleFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotTriangle_U16Ptr(label_id: [*c]const u8, xs: [*c]const ImU16, ys: [*c]const ImU16, zs: [*c]const ImU16, count: c_int, flags: ImPlot3DTriangleFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotTriangle_S32Ptr(label_id: [*c]const u8, xs: [*c]const ImS32, ys: [*c]const ImS32, zs: [*c]const ImS32, count: c_int, flags: ImPlot3DTriangleFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotTriangle_U32Ptr(label_id: [*c]const u8, xs: [*c]const ImU32, ys: [*c]const ImU32, zs: [*c]const ImU32, count: c_int, flags: ImPlot3DTriangleFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotTriangle_S64Ptr(label_id: [*c]const u8, xs: [*c]const ImS64, ys: [*c]const ImS64, zs: [*c]const ImS64, count: c_int, flags: ImPlot3DTriangleFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotTriangle_U64Ptr(label_id: [*c]const u8, xs: [*c]const ImU64, ys: [*c]const ImU64, zs: [*c]const ImU64, count: c_int, flags: ImPlot3DTriangleFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotQuad_FloatPtr(label_id: [*c]const u8, xs: [*c]const f32, ys: [*c]const f32, zs: [*c]const f32, count: c_int, flags: ImPlot3DQuadFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotQuad_doublePtr(label_id: [*c]const u8, xs: [*c]const f64, ys: [*c]const f64, zs: [*c]const f64, count: c_int, flags: ImPlot3DQuadFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotQuad_S8Ptr(label_id: [*c]const u8, xs: [*c]const ImS8, ys: [*c]const ImS8, zs: [*c]const ImS8, count: c_int, flags: ImPlot3DQuadFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotQuad_U8Ptr(label_id: [*c]const u8, xs: [*c]const ImU8, ys: [*c]const ImU8, zs: [*c]const ImU8, count: c_int, flags: ImPlot3DQuadFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotQuad_S16Ptr(label_id: [*c]const u8, xs: [*c]const ImS16, ys: [*c]const ImS16, zs: [*c]const ImS16, count: c_int, flags: ImPlot3DQuadFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotQuad_U16Ptr(label_id: [*c]const u8, xs: [*c]const ImU16, ys: [*c]const ImU16, zs: [*c]const ImU16, count: c_int, flags: ImPlot3DQuadFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotQuad_S32Ptr(label_id: [*c]const u8, xs: [*c]const ImS32, ys: [*c]const ImS32, zs: [*c]const ImS32, count: c_int, flags: ImPlot3DQuadFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotQuad_U32Ptr(label_id: [*c]const u8, xs: [*c]const ImU32, ys: [*c]const ImU32, zs: [*c]const ImU32, count: c_int, flags: ImPlot3DQuadFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotQuad_S64Ptr(label_id: [*c]const u8, xs: [*c]const ImS64, ys: [*c]const ImS64, zs: [*c]const ImS64, count: c_int, flags: ImPlot3DQuadFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotQuad_U64Ptr(label_id: [*c]const u8, xs: [*c]const ImU64, ys: [*c]const ImU64, zs: [*c]const ImU64, count: c_int, flags: ImPlot3DQuadFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotSurface_FloatPtr(label_id: [*c]const u8, xs: [*c]const f32, ys: [*c]const f32, zs: [*c]const f32, x_count: c_int, y_count: c_int, scale_min: f64, scale_max: f64, flags: ImPlot3DSurfaceFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotSurface_doublePtr(label_id: [*c]const u8, xs: [*c]const f64, ys: [*c]const f64, zs: [*c]const f64, x_count: c_int, y_count: c_int, scale_min: f64, scale_max: f64, flags: ImPlot3DSurfaceFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotSurface_S8Ptr(label_id: [*c]const u8, xs: [*c]const ImS8, ys: [*c]const ImS8, zs: [*c]const ImS8, x_count: c_int, y_count: c_int, scale_min: f64, scale_max: f64, flags: ImPlot3DSurfaceFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotSurface_U8Ptr(label_id: [*c]const u8, xs: [*c]const ImU8, ys: [*c]const ImU8, zs: [*c]const ImU8, x_count: c_int, y_count: c_int, scale_min: f64, scale_max: f64, flags: ImPlot3DSurfaceFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotSurface_S16Ptr(label_id: [*c]const u8, xs: [*c]const ImS16, ys: [*c]const ImS16, zs: [*c]const ImS16, x_count: c_int, y_count: c_int, scale_min: f64, scale_max: f64, flags: ImPlot3DSurfaceFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotSurface_U16Ptr(label_id: [*c]const u8, xs: [*c]const ImU16, ys: [*c]const ImU16, zs: [*c]const ImU16, x_count: c_int, y_count: c_int, scale_min: f64, scale_max: f64, flags: ImPlot3DSurfaceFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotSurface_S32Ptr(label_id: [*c]const u8, xs: [*c]const ImS32, ys: [*c]const ImS32, zs: [*c]const ImS32, x_count: c_int, y_count: c_int, scale_min: f64, scale_max: f64, flags: ImPlot3DSurfaceFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotSurface_U32Ptr(label_id: [*c]const u8, xs: [*c]const ImU32, ys: [*c]const ImU32, zs: [*c]const ImU32, x_count: c_int, y_count: c_int, scale_min: f64, scale_max: f64, flags: ImPlot3DSurfaceFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotSurface_S64Ptr(label_id: [*c]const u8, xs: [*c]const ImS64, ys: [*c]const ImS64, zs: [*c]const ImS64, x_count: c_int, y_count: c_int, scale_min: f64, scale_max: f64, flags: ImPlot3DSurfaceFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotSurface_U64Ptr(label_id: [*c]const u8, xs: [*c]const ImU64, ys: [*c]const ImU64, zs: [*c]const ImU64, x_count: c_int, y_count: c_int, scale_min: f64, scale_max: f64, flags: ImPlot3DSurfaceFlags, offset: c_int, stride: c_int) void;
pub extern fn ImPlot3D_PlotMesh(label_id: [*c]const u8, vtx: [*c]const ImPlot3DPoint, idx: [*c]const c_uint, vtx_count: c_int, idx_count: c_int, flags: ImPlot3DMeshFlags) void;
pub extern fn ImPlot3D_PlotImage_Vec2(label_id: [*c]const u8, tex_ref: ImTextureRef, center: ImPlot3DPoint, axis_u: ImPlot3DPoint, axis_v: ImPlot3DPoint, uv0: ImVec2, uv1: ImVec2, tint_col: ImVec4, flags: ImPlot3DImageFlags) void;
pub extern fn ImPlot3D_PlotImage_Plot3DPoInt(label_id: [*c]const u8, tex_ref: ImTextureRef, p0: ImPlot3DPoint, p1: ImPlot3DPoint, p2: ImPlot3DPoint, p3: ImPlot3DPoint, uv0: ImVec2, uv1: ImVec2, uv2: ImVec2, uv3: ImVec2, tint_col: ImVec4, flags: ImPlot3DImageFlags) void;
pub extern fn ImPlot3D_PlotText(text: [*c]const u8, x: f32, y: f32, z: f32, angle: f32, pix_offset: ImVec2) void;
pub extern fn ImPlot3D_PlotToPixels_Plot3DPoInt(pOut: [*c]ImVec2, point: ImPlot3DPoint) void;
pub extern fn ImPlot3D_PlotToPixels_double(pOut: [*c]ImVec2, x: f64, y: f64, z: f64) void;
pub extern fn ImPlot3D_PixelsToPlotRay_Vec2(pix: ImVec2) ImPlot3DRay;
pub extern fn ImPlot3D_PixelsToPlotRay_double(x: f64, y: f64) ImPlot3DRay;
pub extern fn ImPlot3D_PixelsToPlotPlane_Vec2(pOut: [*c]ImPlot3DPoint, pix: ImVec2, plane: ImPlane3D, mask: bool) void;
pub extern fn ImPlot3D_PixelsToPlotPlane_double(pOut: [*c]ImPlot3DPoint, x: f64, y: f64, plane: ImPlane3D, mask: bool) void;
pub extern fn ImPlot3D_GetPlotPos(pOut: [*c]ImVec2) void;
pub extern fn ImPlot3D_GetPlotSize(pOut: [*c]ImVec2) void;
pub extern fn ImPlot3D_GetPlotDrawList() [*c]ImDrawList;
pub extern fn ImPlot3D_GetStyle() [*c]ImPlot3DStyle;
pub extern fn ImPlot3D_SetStyle(style: ImPlot3DStyle) void;
pub extern fn ImPlot3D_StyleColorsAuto(dst: [*c]ImPlot3DStyle) void;
pub extern fn ImPlot3D_StyleColorsDark(dst: [*c]ImPlot3DStyle) void;
pub extern fn ImPlot3D_StyleColorsLight(dst: [*c]ImPlot3DStyle) void;
pub extern fn ImPlot3D_StyleColorsClassic(dst: [*c]ImPlot3DStyle) void;
pub extern fn ImPlot3D_PushStyleColor_U32(idx: ImPlot3DCol, col: ImU32) void;
pub extern fn ImPlot3D_PushStyleColor_Vec4(idx: ImPlot3DCol, col: ImVec4) void;
pub extern fn ImPlot3D_PopStyleColor(count: c_int) void;
pub extern fn ImPlot3D_PushStyleVar_Float(idx: ImPlot3DStyleVar, val: f32) void;
pub extern fn ImPlot3D_PushStyleVar_Int(idx: ImPlot3DStyleVar, val: c_int) void;
pub extern fn ImPlot3D_PushStyleVar_Vec2(idx: ImPlot3DStyleVar, val: ImVec2) void;
pub extern fn ImPlot3D_PopStyleVar(count: c_int) void;
pub extern fn ImPlot3D_SetNextLineStyle(col: ImVec4, weight: f32) void;
pub extern fn ImPlot3D_SetNextFillStyle(col: ImVec4, alpha_mod: f32) void;
pub extern fn ImPlot3D_SetNextMarkerStyle(marker: ImPlot3DMarker, size: f32, fill: ImVec4, weight: f32, outline: ImVec4) void;
pub extern fn ImPlot3D_GetStyleColorVec4(pOut: [*c]ImVec4, idx: ImPlot3DCol) void;
pub extern fn ImPlot3D_GetStyleColorU32(idx: ImPlot3DCol) ImU32;
pub extern fn ImPlot3D_AddColormap_Vec4Ptr(name: [*c]const u8, cols: [*c]const ImVec4, size: c_int, qual: bool) ImPlot3DColormap;
pub extern fn ImPlot3D_AddColormap_U32Ptr(name: [*c]const u8, cols: [*c]const ImU32, size: c_int, qual: bool) ImPlot3DColormap;
pub extern fn ImPlot3D_GetColormapCount() c_int;
pub extern fn ImPlot3D_GetColormapName(cmap: ImPlot3DColormap) [*c]const u8;
pub extern fn ImPlot3D_GetColormapIndex(name: [*c]const u8) ImPlot3DColormap;
pub extern fn ImPlot3D_PushColormap_Plot3DColormap(cmap: ImPlot3DColormap) void;
pub extern fn ImPlot3D_PushColormap_Str(name: [*c]const u8) void;
pub extern fn ImPlot3D_PopColormap(count: c_int) void;
pub extern fn ImPlot3D_NextColormapColor(pOut: [*c]ImVec4) void;
pub extern fn ImPlot3D_GetColormapSize(cmap: ImPlot3DColormap) c_int;
pub extern fn ImPlot3D_GetColormapColor(pOut: [*c]ImVec4, idx: c_int, cmap: ImPlot3DColormap) void;
pub extern fn ImPlot3D_SampleColormap(pOut: [*c]ImVec4, t: f32, cmap: ImPlot3DColormap) void;
pub extern fn ImPlot3D_ShowDemoWindow(p_open: [*c]bool) void;
pub extern fn ImPlot3D_ShowAllDemos() void;
pub extern fn ImPlot3D_ShowStyleEditor(ref: [*c]ImPlot3DStyle) void;
pub extern fn ImPlot3D_ShowMetricsWindow(p_popen: [*c]bool) void;
pub extern fn ImPlot3DPoint_ImPlot3DPoint_Nil() [*c]ImPlot3DPoint;
pub extern fn ImPlot3DPoint_destroy(self: [*c]ImPlot3DPoint) void;
pub extern fn ImPlot3DPoint_ImPlot3DPoint_Float(_x: f32, _y: f32, _z: f32) [*c]ImPlot3DPoint;
pub extern fn ImPlot3DPoint_Dot(self: [*c]ImPlot3DPoint, rhs: ImPlot3DPoint) f32;
pub extern fn ImPlot3DPoint_Cross(pOut: [*c]ImPlot3DPoint, self: [*c]ImPlot3DPoint, rhs: ImPlot3DPoint) void;
pub extern fn ImPlot3DPoint_Length(self: [*c]ImPlot3DPoint) f32;
pub extern fn ImPlot3DPoint_LengthSquared(self: [*c]ImPlot3DPoint) f32;
pub extern fn ImPlot3DPoint_Normalize(self: [*c]ImPlot3DPoint) void;
pub extern fn ImPlot3DPoint_Normalized(pOut: [*c]ImPlot3DPoint, self: [*c]ImPlot3DPoint) void;
pub extern fn ImPlot3DPoint_IsNaN(self: [*c]ImPlot3DPoint) bool;
pub extern fn ImPlot3DBox_ImPlot3DBox_Nil() [*c]ImPlot3DBox;
pub extern fn ImPlot3DBox_destroy(self: [*c]ImPlot3DBox) void;
pub extern fn ImPlot3DBox_ImPlot3DBox_Plot3DPoInt(min: ImPlot3DPoint, max: ImPlot3DPoint) [*c]ImPlot3DBox;
pub extern fn ImPlot3DBox_Expand(self: [*c]ImPlot3DBox, point: ImPlot3DPoint) void;
pub extern fn ImPlot3DBox_Contains(self: [*c]ImPlot3DBox, point: ImPlot3DPoint) bool;
pub extern fn ImPlot3DBox_ClipLineSegment(self: [*c]ImPlot3DBox, p0: ImPlot3DPoint, p1: ImPlot3DPoint, p0_clipped: [*c]ImPlot3DPoint, p1_clipped: [*c]ImPlot3DPoint) bool;
pub extern fn ImPlot3DRange_ImPlot3DRange_Nil() [*c]ImPlot3DRange;
pub extern fn ImPlot3DRange_destroy(self: [*c]ImPlot3DRange) void;
pub extern fn ImPlot3DRange_ImPlot3DRange_Float(min: f32, max: f32) [*c]ImPlot3DRange;
pub extern fn ImPlot3DRange_Expand(self: [*c]ImPlot3DRange, value: f32) void;
pub extern fn ImPlot3DRange_Contains(self: [*c]ImPlot3DRange, value: f32) bool;
pub extern fn ImPlot3DRange_Size(self: [*c]ImPlot3DRange) f32;
pub extern fn ImPlot3DQuat_ImPlot3DQuat_Nil() [*c]ImPlot3DQuat;
pub extern fn ImPlot3DQuat_destroy(self: [*c]ImPlot3DQuat) void;
pub extern fn ImPlot3DQuat_ImPlot3DQuat_FloatFloat(_x: f32, _y: f32, _z: f32, _w: f32) [*c]ImPlot3DQuat;
pub extern fn ImPlot3DQuat_ImPlot3DQuat_FloatPlot3DPoInt(_angle: f32, _axis: ImPlot3DPoint) [*c]ImPlot3DQuat;
pub extern fn ImPlot3DQuat_FromTwoVectors(pOut: [*c]ImPlot3DQuat, v0: ImPlot3DPoint, v1: ImPlot3DPoint) void;
pub extern fn ImPlot3DQuat_FromElAz(pOut: [*c]ImPlot3DQuat, elevation: f32, azimuth: f32) void;
pub extern fn ImPlot3DQuat_Length(self: [*c]ImPlot3DQuat) f32;
pub extern fn ImPlot3DQuat_Normalized(pOut: [*c]ImPlot3DQuat, self: [*c]ImPlot3DQuat) void;
pub extern fn ImPlot3DQuat_Conjugate(pOut: [*c]ImPlot3DQuat, self: [*c]ImPlot3DQuat) void;
pub extern fn ImPlot3DQuat_Inverse(pOut: [*c]ImPlot3DQuat, self: [*c]ImPlot3DQuat) void;
pub extern fn ImPlot3DQuat_Normalize(self: [*c]ImPlot3DQuat) [*c]ImPlot3DQuat;
pub extern fn ImPlot3DQuat_Slerp(pOut: [*c]ImPlot3DQuat, q1: ImPlot3DQuat, q2: ImPlot3DQuat, t: f32) void;
pub extern fn ImPlot3DQuat_Dot(self: [*c]ImPlot3DQuat, rhs: ImPlot3DQuat) f32;
pub extern fn ImPlot3DStyle_GetColor(pOut: [*c]ImVec4, self: [*c]ImPlot3DStyle, idx: ImPlot3DCol) void;
pub extern fn ImPlot3DStyle_SetColor(self: [*c]ImPlot3DStyle, idx: ImPlot3DCol, col: ImVec4) void;
pub extern fn ImPlot3DStyle_ImPlot3DStyle_Nil() [*c]ImPlot3DStyle;
pub extern fn ImPlot3DStyle_destroy(self: [*c]ImPlot3DStyle) void;
pub extern fn ImPlot3DStyle_ImPlot3DStyle_Plot3DStyle(other: ImPlot3DStyle) [*c]ImPlot3DStyle;
...
// C:\imguinz\examples\glfw_opengl3_implot3d\../../src/libzig/implot3d\..\..\libc\cimgui/cimgui.h:14:17
...
// C:\imguinz\examples\glfw_opengl3_implot3d\../../src/libzig/implot3d\..\..\libc\cimgui/cimgui.h:29:13
pub const CIMGUI_API = EXTERN ++ API;
pub const CONST = @compileError("unable to translate C expr: unexpected token 'const'");
// C:\imguinz\examples\glfw_opengl3_implot3d\../../src/libzig/implot3d\..\..\libc\cimgui/cimgui.h:33:9
