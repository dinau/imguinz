...
// C:\imguinz\examples\glfw_opengl3_imfileopendialog\../../src/libzig/imfileopendialog\..\..\libc\cimgui/cimgui.h:1560:18: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_imfileopendialog\../../src/libzig/imfileopendialog\..\..\libc\cimgui/cimgui.h:1643:18: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_imfileopendialog\../../src/libzig/imfileopendialog\..\..\libc\cimgui/cimgui.h:3761:9: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_imfileopendialog\../../src/libzig/imfileopendialog\..\..\libc\cimgui/cimgui.h:3387:29: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_imfileopendialog\../../src/libzig/imfileopendialog\..\..\libc\cimgui/cimgui.h:3552:10: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_imfileopendialog\../../src/libzig/imfileopendialog\..\..\libc\cimgui/cimgui.h:3615:24: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_imfileopendialog\../../src/libzig/imfileopendialog\..\..\libc\cimgui/cimgui.h:2578:19: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_imfileopendialog\../../src/libzig/imfileopendialog\..\..\libc\cimgui/cimgui.h:2681:24: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_imfileopendialog\../../src/libzig/imfileopendialog\..\..\libc\cimgui/cimgui.h:1925:11: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_imfileopendialog\../../src/libzig/imfileopendialog\..\..\libc\cimgui/cimgui.h:3733:10: warning: struct demoted to opaque type - has bitfield
...
pub const IGFD_FileStyleFlags = c_int;
pub const IGFD_FileStyle_None: c_int = 0;
pub const IGFD_FileStyleByTypeFile: c_int = 1;
pub const IGFD_FileStyleByTypeDir: c_int = 2;
pub const IGFD_FileStyleByTypeLink: c_int = 4;
pub const IGFD_FileStyleByExtention: c_int = 8;
pub const IGFD_FileStyleByFullName: c_int = 16;
pub const IGFD_FileStyleByContainedInFullName: c_int = 32;
pub const enum_IGFD_FileStyleFlags_ = c_uint;
pub const ImGuiFileDialogFlags = c_int;
pub const ImGuiFileDialogFlags_None: c_int = 0;
pub const ImGuiFileDialogFlags_ConfirmOverwrite: c_int = 1;
pub const ImGuiFileDialogFlags_DontShowHiddenFiles: c_int = 2;
pub const ImGuiFileDialogFlags_DisableCreateDirectoryButton: c_int = 4;
pub const ImGuiFileDialogFlags_HideColumnType: c_int = 8;
pub const ImGuiFileDialogFlags_HideColumnSize: c_int = 16;
pub const ImGuiFileDialogFlags_HideColumnDate: c_int = 32;
pub const ImGuiFileDialogFlags_NoDialog: c_int = 64;
pub const ImGuiFileDialogFlags_ReadOnlyFileNameField: c_int = 128;
pub const ImGuiFileDialogFlags_CaseInsensitiveExtentionFiltering: c_int = 256;
pub const ImGuiFileDialogFlags_Modal: c_int = 512;
pub const ImGuiFileDialogFlags_DisableThumbnailMode: c_int = 1024;
pub const ImGuiFileDialogFlags_DisablePlaceMode: c_int = 2048;
pub const ImGuiFileDialogFlags_DisableQuickPathSelection: c_int = 4096;
pub const ImGuiFileDialogFlags_ShowDevicesButton: c_int = 8192;
pub const ImGuiFileDialogFlags_NaturalSorting: c_int = 16384;
pub const ImGuiFileDialogFlags_OptionalFileName: c_int = 32768;
pub const ImGuiFileDialogFlags_Default: c_int = 521;
pub const enum_ImGuiFileDialogFlags_ = c_uint;
pub const IGFD_ResultMode = c_int;
pub const IGFD_ResultMode_AddIfNoFileExt: c_int = 0;
pub const IGFD_ResultMode_OverwriteFileExt: c_int = 1;
pub const IGFD_ResultMode_KeepInputFile: c_int = 2;
pub const enum_IGFD_ResultMode_ = c_uint;
pub const struct_ImGuiFileDialog = opaque {};
pub const ImGuiFileDialog = struct_ImGuiFileDialog;
pub const struct_IGFD_Selection_Pair = extern struct {
    fileName: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    filePathName: [*c]u8 = @import("std").mem.zeroes([*c]u8),
};
pub const IGFD_Selection_Pair = struct_IGFD_Selection_Pair;
pub const struct_IGFD_Selection = extern struct {
    table: [*c]IGFD_Selection_Pair = @import("std").mem.zeroes([*c]IGFD_Selection_Pair),
    count: usize = @import("std").mem.zeroes(usize),
};
pub const IGFD_Selection = struct_IGFD_Selection;
pub const IGFD_PaneFun = ?*const fn ([*c]const u8, ?*anyopaque, [*c]bool) callconv(.c) void;
pub const struct_IGFD_FileDialog_Config = extern struct {
    path: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    fileName: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    filePathName: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    countSelectionMax: i32 = @import("std").mem.zeroes(i32),
    userDatas: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    sidePane: IGFD_PaneFun = @import("std").mem.zeroes(IGFD_PaneFun),
    sidePaneWidth: f32 = @import("std").mem.zeroes(f32),
    flags: ImGuiFileDialogFlags = @import("std").mem.zeroes(ImGuiFileDialogFlags),
};
pub extern fn IGFD_FileDialog_Config_Get(...) struct_IGFD_FileDialog_Config;
pub extern fn IGFD_Selection_Pair_Get(...) IGFD_Selection_Pair;
pub extern fn IGFD_Selection_Pair_DestroyContent(vSelection_Pair: [*c]IGFD_Selection_Pair) void;
pub extern fn IGFD_Selection_Get(...) IGFD_Selection;
pub extern fn IGFD_Selection_DestroyContent(vSelection: [*c]IGFD_Selection) void;
pub extern fn IGFD_Create() ?*ImGuiFileDialog;
pub extern fn IGFD_Destroy(vContextPtr: ?*ImGuiFileDialog) void;
pub extern fn IGFD_OpenDialog(vContextPtr: ?*ImGuiFileDialog, vKey: [*c]const u8, vTitle: [*c]const u8, vFilters: [*c]const u8, vConfig: struct_IGFD_FileDialog_Config) void;
pub extern fn IGFD_DisplayDialog(vContextPtr: ?*ImGuiFileDialog, vKey: [*c]const u8, vFlags: ImGuiWindowFlags, vMinSize: ImVec2, vMaxSize: ImVec2) bool;
pub extern fn IGFD_CloseDialog(vContextPtr: ?*ImGuiFileDialog) void;
pub extern fn IGFD_IsOk(vContextPtr: ?*ImGuiFileDialog) bool;
pub extern fn IGFD_WasKeyOpenedThisFrame(vContextPtr: ?*ImGuiFileDialog, vKey: [*c]const u8) bool;
pub extern fn IGFD_WasOpenedThisFrame(vContextPtr: ?*ImGuiFileDialog) bool;
pub extern fn IGFD_IsKeyOpened(vContextPtr: ?*ImGuiFileDialog, vCurrentOpenedKey: [*c]const u8) bool;
pub extern fn IGFD_IsOpened(vContextPtr: ?*ImGuiFileDialog) bool;
pub extern fn IGFD_GetSelection(vContextPtr: ?*ImGuiFileDialog, vMode: IGFD_ResultMode) IGFD_Selection;
pub extern fn IGFD_GetFilePathName(vContextPtr: ?*ImGuiFileDialog, vMode: IGFD_ResultMode) [*c]u8;
pub extern fn IGFD_GetCurrentFileName(vContextPtr: ?*ImGuiFileDialog, vMode: IGFD_ResultMode) [*c]u8;
pub extern fn IGFD_GetCurrentPath(vContextPtr: ?*ImGuiFileDialog) [*c]u8;
pub extern fn IGFD_GetCurrentFilter(vContextPtr: ?*ImGuiFileDialog) [*c]u8;
pub extern fn IGFD_GetUserDatas(vContextPtr: ?*ImGuiFileDialog) ?*anyopaque;
pub extern fn IGFD_SetFileStyle(vContextPtr: ?*ImGuiFileDialog, vFileStyleFlags: IGFD_FileStyleFlags, vFilter: [*c]const u8, vColor: ImVec4, vIconText: [*c]const u8, vFont: [*c]ImFont) void;
pub extern fn IGFD_SetFileStyle2(vContextPtr: ?*ImGuiFileDialog, vFileStyleFlags: IGFD_FileStyleFlags, vFilter: [*c]const u8, vR: f32, vG: f32, vB: f32, vA: f32, vIconText: [*c]const u8, vFont: [*c]ImFont) void;
pub extern fn IGFD_GetFileStyle(vContextPtr: ?*ImGuiFileDialog, vFileStyleFlags: IGFD_FileStyleFlags, vFilter: [*c]const u8, vOutColor: [*c]ImVec4, vOutIconText: [*c][*c]u8, vOutFont: [*c][*c]ImFont) bool;
pub extern fn IGFD_ClearFilesStyle(vContextPtr: ?*ImGuiFileDialog) void;
pub extern fn SetLocales(vContextPtr: ?*ImGuiFileDialog, vCategory: c_int, vBeginLocale: [*c]const u8, vEndLocale: [*c]const u8) void;
...
// C:\imguinz\examples\glfw_opengl3_imfileopendialog\../../src/libzig/imfileopendialog\..\..\libc\cimgui/cimgui.h:14:17
...
// C:\imguinz\examples\glfw_opengl3_imfileopendialog\../../src/libzig/imfileopendialog\..\..\libc\cimgui/cimgui.h:29:13
pub const CIMGUI_API = EXTERN ++ API;
pub const CONST = @compileError("unable to translate C expr: unexpected token 'const'");
// C:\imguinz\examples\glfw_opengl3_imfileopendialog\../../src/libzig/imfileopendialog\..\..\libc\cimgui/cimgui.h:33:9
...
pub const IGFD_VERSION = "v0.6.8";
pub const IGFD_IMGUI_SUPPORTED_VERSION = "1.92.3";
pub const IGFD_API = "";
pub const IGFD_C_API = "";
...
pub const IGFD_FileStyleFlags_ = enum_IGFD_FileStyleFlags_;
pub const ImGuiFileDialogFlags_ = enum_ImGuiFileDialogFlags_;
pub const IGFD_ResultMode_ = enum_IGFD_ResultMode_;
pub const IGFD_FileDialog_Config = struct_IGFD_FileDialog_Config;
