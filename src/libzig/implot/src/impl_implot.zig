...
// C:\imguinz\examples\glfw_opengl3_implot\../../src/libzig/implot\..\..\libc\cimgui/cimgui.h:1569:18: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_implot\../../src/libzig/implot\..\..\libc\cimgui/cimgui.h:1652:18: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_implot\../../src/libzig/implot\..\..\libc\cimgui/cimgui.h:3777:9: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_implot\../../src/libzig/implot\..\..\libc\cimgui/cimgui.h:3403:29: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_implot\../../src/libzig/implot\..\..\libc\cimgui/cimgui.h:3568:10: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_implot\../../src/libzig/implot\..\..\libc\cimgui/cimgui.h:3631:24: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_implot\../../src/libzig/implot\..\..\libc\cimgui/cimgui.h:2591:19: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_implot\../../src/libzig/implot\..\..\libc\cimgui/cimgui.h:2694:24: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_implot\../../src/libzig/implot\..\..\libc\cimgui/cimgui.h:1937:11: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_implot\../../src/libzig/implot\..\..\libc\cimgui/cimgui.h:3749:10: warning: struct demoted to opaque type - has bitfield
...
pub const ImPlotTick_c = struct_ImPlotTick_c;
pub const struct_ImVector_ImPlotTick = extern struct {
    Size: c_int = @import("std").mem.zeroes(c_int),
    Capacity: c_int = @import("std").mem.zeroes(c_int),
    Data: [*c]ImPlotTick_c = @import("std").mem.zeroes([*c]ImPlotTick_c),
};
...
pub const struct_ImPlotTicker = extern struct {
    ...
    MaxSize: ImVec2_c = @import("std").mem.zeroes(ImVec2_c),
    LateSize: ImVec2_c = @import("std").mem.zeroes(ImVec2_c),
...
pub const ImPlotLocator = ?*const fn ([*c]ImPlotTicker, ImPlotRange_c, f32, bool, ImPlotFormatter, ?*anyopaque) callconv(.c) void;
pub const struct_ImPlotTime_c = extern struct {
    S: time_t = @import("std").mem.zeroes(time_t),
    Us: c_int = @import("std").mem.zeroes(c_int),
};
pub const ImPlotTime_c = struct_ImPlotTime_c;
pub const ImPlotTransform = ?*const fn (f64, ?*anyopaque) callconv(.c) f64;
pub const struct_ImPlotAxis_c = extern struct {
    ID: ImGuiID = @import("std").mem.zeroes(ImGuiID),
    ...
    Range: ImPlotRange_c = @import("std").mem.zeroes(ImPlotRange_c),
    RangeCond: ImPlotCond = @import("std").mem.zeroes(ImPlotCond),
    Scale: ImPlotScale = @import("std").mem.zeroes(ImPlotScale),
    FitExtents: ImPlotRange_c = @import("std").mem.zeroes(ImPlotRange_c),
    OrthoAxis: [*c]ImPlotAxis_c = @import("std").mem.zeroes([*c]ImPlotAxis_c),
    ConstraintRange: ImPlotRange_c = @import("std").mem.zeroes(ImPlotRange_c),
    ConstraintZoom: ImPlotRange_c = @import("std").mem.zeroes(ImPlotRange_c),
    ...
    PickerTimeMin: ImPlotTime_c = @import("std").mem.zeroes(ImPlotTime_c),
    PickerTimeMax: ImPlotTime_c = @import("std").mem.zeroes(ImPlotTime_c),
    ...
    HoverRect: ImRect_c = @import("std").mem.zeroes(ImRect_c),
...
pub const ImPlotAxis_c = struct_ImPlotAxis_c;
...
pub const struct_ImPlotLegend = extern struct {
    ...
    Rect: ImRect_c = @import("std").mem.zeroes(ImRect_c),
    RectClamped: ImRect_c = @import("std").mem.zeroes(ImRect_c),
    Hovered: bool = @import("std").mem.zeroes(bool),
    Held: bool = @import("std").mem.zeroes(bool),
...
pub const struct_ImPlotItem = extern struct {
    ...
    LegendHoverRect: ImRect_c = @import("std").mem.zeroes(ImRect_c),
...
pub const struct_ImPlotPlot = extern struct {
    ...
    Axes: [6]ImPlotAxis_c = @import("std").mem.zeroes([6]ImPlotAxis_c),
    TextBuffer: ImGuiTextBuffer = @import("std").mem.zeroes(ImGuiTextBuffer),
    ...
    FrameRect: ImRect_c = @import("std").mem.zeroes(ImRect_c),
    CanvasRect: ImRect_c = @import("std").mem.zeroes(ImRect_c),
    PlotRect: ImRect_c = @import("std").mem.zeroes(ImRect_c),
    AxesRect: ImRect_c = @import("std").mem.zeroes(ImRect_c),
    SelectRect: ImRect_c = @import("std").mem.zeroes(ImRect_c),
    SelectStart: ImVec2_c = @import("std").mem.zeroes(ImVec2_c),
...
pub const struct_ImVector_ImPlotRange = extern struct {
    Size: c_int = @import("std").mem.zeroes(c_int),
    Capacity: c_int = @import("std").mem.zeroes(c_int),
    Data: [*c]ImPlotRange_c = @import("std").mem.zeroes([*c]ImPlotRange_c),
};
...
pub const struct_ImPlotSubplot = extern struct {
    ...
    FrameRect: ImRect_c = @import("std").mem.zeroes(ImRect_c),
    GridRect: ImRect_c = @import("std").mem.zeroes(ImRect_c),
    CellSize: ImVec2_c = @import("std").mem.zeroes(ImVec2_c),
...
pub const struct_ImPlotAnnotation = extern struct {
    Pos: ImVec2_c = @import("std").mem.zeroes(ImVec2_c),
    Offset: ImVec2_c = @import("std").mem.zeroes(ImVec2_c),
    ColorBg: ImU32 = @import("std").mem.zeroes(ImU32),
...
pub const struct_ImPlotStyle = extern struct {
    ...
    MajorTickLen: ImVec2_c = @import("std").mem.zeroes(ImVec2_c),
    MinorTickLen: ImVec2_c = @import("std").mem.zeroes(ImVec2_c),
    MajorTickSize: ImVec2_c = @import("std").mem.zeroes(ImVec2_c),
    MinorTickSize: ImVec2_c = @import("std").mem.zeroes(ImVec2_c),
    MajorGridSize: ImVec2_c = @import("std").mem.zeroes(ImVec2_c),
    MinorGridSize: ImVec2_c = @import("std").mem.zeroes(ImVec2_c),
    PlotPadding: ImVec2_c = @import("std").mem.zeroes(ImVec2_c),
    LabelPadding: ImVec2_c = @import("std").mem.zeroes(ImVec2_c),
    LegendPadding: ImVec2_c = @import("std").mem.zeroes(ImVec2_c),
    LegendInnerPadding: ImVec2_c = @import("std").mem.zeroes(ImVec2_c),
    LegendSpacing: ImVec2_c = @import("std").mem.zeroes(ImVec2_c),
    MousePosPadding: ImVec2_c = @import("std").mem.zeroes(ImVec2_c),
    AnnotationPadding: ImVec2_c = @import("std").mem.zeroes(ImVec2_c),
    FitPadding: ImVec2_c = @import("std").mem.zeroes(ImVec2_c),
    PlotDefaultSize: ImVec2_c = @import("std").mem.zeroes(ImVec2_c),
    PlotMinSize: ImVec2_c = @import("std").mem.zeroes(ImVec2_c),
    Colors: [21]ImVec4_c = @import("std").mem.zeroes([21]ImVec4_c),
...
pub const struct_ImPlotNextPlotData = extern struct {
    ...
    Range: [6]ImPlotRange_c = @import("std").mem.zeroes([6]ImPlotRange_c),
...
pub const struct_ImPlotNextItemData = extern struct {
    Colors: [5]ImVec4_c = @import("std").mem.zeroes([5]ImVec4_c),
    LineWeight: f32 = @import("std").mem.zeroes(f32),
...
pub const ImPlotFlags_NoFrame: c_int = 64;
pub const ImPlotFlags_Equal: c_int = 128;
pub const ImPlotFlags_Crosshairs: c_int = 256;
...
pub const ImPlotLegendFlags_Reverse: c_int = 128;
...
pub const ImPlotPieChartFlags_IgnoreHidden: c_int = 2048;
pub const ImPlotPieChartFlags_Exploding: c_int = 4096;
...
pub const struct_ImPlotPoint_c = extern struct {
    x: f64 = @import("std").mem.zeroes(f64),
    y: f64 = @import("std").mem.zeroes(f64),
};
pub const ImPlotPoint_c = struct_ImPlotPoint_c;
pub const struct_ImPlotRect_c = extern struct {
    X: ImPlotRange_c = @import("std").mem.zeroes(ImPlotRange_c),
    Y: ImPlotRange_c = @import("std").mem.zeroes(ImPlotRange_c),
};
pub const ImPlotRect_c = struct_ImPlotRect_c;
pub const ImPlotGetter = ?*const fn (c_int, ?*anyopaque) callconv(.c) ImPlotPoint_c;
...
pub const struct_ImPlotDateTimeSpec_c = extern struct {
    Date: ImPlotDateFmt = @import("std").mem.zeroes(ImPlotDateFmt),
    Time: ImPlotTimeFmt = @import("std").mem.zeroes(ImPlotTimeFmt),
    UseISO8601: bool = @import("std").mem.zeroes(bool),
    Use24HourClock: bool = @import("std").mem.zeroes(bool),
};
pub const ImPlotDateTimeSpec_c = struct_ImPlotDateTimeSpec_c;
...
pub const struct_Formatter_Time_Data = extern struct {
    Time: ImPlotTime_c = @import("std").mem.zeroes(ImPlotTime_c),
    Spec: ImPlotDateTimeSpec_c = @import("std").mem.zeroes(ImPlotDateTimeSpec_c),
...
pub const ImPlotDateTimeSpec = struct_ImPlotDateTimeSpec_c;
pub const ImPlotPoint = struct_ImPlotPoint_c;
pub const ImPlotRange = struct_ImPlotRange_c;
pub const ImPlotTime = struct_ImPlotTime_c;
pub const ImPlotRect = struct_ImPlotRect_c;
pub const ImPlotTick = struct_ImPlotTick_c;
pub const ImPlotAxis = struct_ImPlotAxis_c;
pub const ImPlotPoint_getter = ?*const fn (?*anyopaque, c_int, [*c]ImPlotPoint_c) callconv(.c) ?*anyopaque;
...
pub extern fn ImPlotPoint_ImPlotPoint_Vec2(p: ImVec2_c) [*c]ImPlotPoint;
...
pub extern fn ImPlotRect_Contains_PlotPoInt(self: [*c]ImPlotRect, p: ImPlotPoint_c) bool;
pub extern fn ImPlotRect_Contains_double(self: [*c]ImPlotRect, x: f64, y: f64) bool;
pub extern fn ImPlotRect_Size(self: [*c]ImPlotRect) ImPlotPoint_c;
pub extern fn ImPlotRect_Clamp_PlotPoInt(self: [*c]ImPlotRect, p: ImPlotPoint_c) ImPlotPoint_c;
pub extern fn ImPlotRect_Clamp_double(self: [*c]ImPlotRect, x: f64, y: f64) ImPlotPoint_c;
pub extern fn ImPlotRect_Min(self: [*c]ImPlotRect) ImPlotPoint_c;
pub extern fn ImPlotRect_Max(self: [*c]ImPlotRect) ImPlotPoint_c;
...
pub extern fn ImPlot_BeginPlot(title_id: [*c]const u8, size: ImVec2_c, flags: ImPlotFlags) bool;
pub extern fn ImPlot_EndPlot() void;
pub extern fn ImPlot_BeginSubplots(title_id: [*c]const u8, rows: c_int, cols: c_int, size: ImVec2_c, flags: ImPlotSubplotFlags, row_ratios: [*c]f32, col_ratios: [*c]f32) bool;
...
pub extern fn ImPlot_PlotPieChart_FloatPtrPlotFormatter(label_ids: [*c]const [*c]const u8, values: [*c]const f32, count: c_int, x: f64, y: f64, radius: f64, fmt: ImPlotFormatter, fmt_data: ?*anyopaque, angle0: f64, flags: ImPlotPieChartFlags) void;
pub extern fn ImPlot_PlotPieChart_doublePtrPlotFormatter(label_ids: [*c]const [*c]const u8, values: [*c]const f64, count: c_int, x: f64, y: f64, radius: f64, fmt: ImPlotFormatter, fmt_data: ?*anyopaque, angle0: f64, flags: ImPlotPieChartFlags) void;
pub extern fn ImPlot_PlotPieChart_S8PtrPlotFormatter(label_ids: [*c]const [*c]const u8, values: [*c]const ImS8, count: c_int, x: f64, y: f64, radius: f64, fmt: ImPlotFormatter, fmt_data: ?*anyopaque, angle0: f64, flags: ImPlotPieChartFlags) void;
pub extern fn ImPlot_PlotPieChart_U8PtrPlotFormatter(label_ids: [*c]const [*c]const u8, values: [*c]const ImU8, count: c_int, x: f64, y: f64, radius: f64, fmt: ImPlotFormatter, fmt_data: ?*anyopaque, angle0: f64, flags: ImPlotPieChartFlags) void;
pub extern fn ImPlot_PlotPieChart_S16PtrPlotFormatter(label_ids: [*c]const [*c]const u8, values: [*c]const ImS16, count: c_int, x: f64, y: f64, radius: f64, fmt: ImPlotFormatter, fmt_data: ?*anyopaque, angle0: f64, flags: ImPlotPieChartFlags) void;
pub extern fn ImPlot_PlotPieChart_U16PtrPlotFormatter(label_ids: [*c]const [*c]const u8, values: [*c]const ImU16, count: c_int, x: f64, y: f64, radius: f64, fmt: ImPlotFormatter, fmt_data: ?*anyopaque, angle0: f64, flags: ImPlotPieChartFlags) void;
pub extern fn ImPlot_PlotPieChart_S32PtrPlotFormatter(label_ids: [*c]const [*c]const u8, values: [*c]const ImS32, count: c_int, x: f64, y: f64, radius: f64, fmt: ImPlotFormatter, fmt_data: ?*anyopaque, angle0: f64, flags: ImPlotPieChartFlags) void;
pub extern fn ImPlot_PlotPieChart_U32PtrPlotFormatter(label_ids: [*c]const [*c]const u8, values: [*c]const ImU32, count: c_int, x: f64, y: f64, radius: f64, fmt: ImPlotFormatter, fmt_data: ?*anyopaque, angle0: f64, flags: ImPlotPieChartFlags) void;
pub extern fn ImPlot_PlotPieChart_S64PtrPlotFormatter(label_ids: [*c]const [*c]const u8, values: [*c]const ImS64, count: c_int, x: f64, y: f64, radius: f64, fmt: ImPlotFormatter, fmt_data: ?*anyopaque, angle0: f64, flags: ImPlotPieChartFlags) void;
pub extern fn ImPlot_PlotPieChart_U64PtrPlotFormatter(label_ids: [*c]const [*c]const u8, values: [*c]const ImU64, count: c_int, x: f64, y: f64, radius: f64, fmt: ImPlotFormatter, fmt_data: ?*anyopaque, angle0: f64, flags: ImPlotPieChartFlags) void;
pub extern fn ImPlot_PlotPieChart_FloatPtrStr(label_ids: [*c]const [*c]const u8, values: [*c]const f32, count: c_int, x: f64, y: f64, radius: f64, label_fmt: [*c]const u8, angle0: f64, flags: ImPlotPieChartFlags) void;
pub extern fn ImPlot_PlotPieChart_doublePtrStr(label_ids: [*c]const [*c]const u8, values: [*c]const f64, count: c_int, x: f64, y: f64, radius: f64, label_fmt: [*c]const u8, angle0: f64, flags: ImPlotPieChartFlags) void;
pub extern fn ImPlot_PlotPieChart_S8PtrStr(label_ids: [*c]const [*c]const u8, values: [*c]const ImS8, count: c_int, x: f64, y: f64, radius: f64, label_fmt: [*c]const u8, angle0: f64, flags: ImPlotPieChartFlags) void;
pub extern fn ImPlot_PlotPieChart_U8PtrStr(label_ids: [*c]const [*c]const u8, values: [*c]const ImU8, count: c_int, x: f64, y: f64, radius: f64, label_fmt: [*c]const u8, angle0: f64, flags: ImPlotPieChartFlags) void;
pub extern fn ImPlot_PlotPieChart_S16PtrStr(label_ids: [*c]const [*c]const u8, values: [*c]const ImS16, count: c_int, x: f64, y: f64, radius: f64, label_fmt: [*c]const u8, angle0: f64, flags: ImPlotPieChartFlags) void;
pub extern fn ImPlot_PlotPieChart_U16PtrStr(label_ids: [*c]const [*c]const u8, values: [*c]const ImU16, count: c_int, x: f64, y: f64, radius: f64, label_fmt: [*c]const u8, angle0: f64, flags: ImPlotPieChartFlags) void;
pub extern fn ImPlot_PlotPieChart_S32PtrStr(label_ids: [*c]const [*c]const u8, values: [*c]const ImS32, count: c_int, x: f64, y: f64, radius: f64, label_fmt: [*c]const u8, angle0: f64, flags: ImPlotPieChartFlags) void;
pub extern fn ImPlot_PlotPieChart_U32PtrStr(label_ids: [*c]const [*c]const u8, values: [*c]const ImU32, count: c_int, x: f64, y: f64, radius: f64, label_fmt: [*c]const u8, angle0: f64, flags: ImPlotPieChartFlags) void;
pub extern fn ImPlot_PlotPieChart_S64PtrStr(label_ids: [*c]const [*c]const u8, values: [*c]const ImS64, count: c_int, x: f64, y: f64, radius: f64, label_fmt: [*c]const u8, angle0: f64, flags: ImPlotPieChartFlags) void;
pub extern fn ImPlot_PlotPieChart_U64PtrStr(label_ids: [*c]const [*c]const u8, values: [*c]const ImU64, count: c_int, x: f64, y: f64, radius: f64, label_fmt: [*c]const u8, angle0: f64, flags: ImPlotPieChartFlags) void;
pub extern fn ImPlot_PlotHeatmap_FloatPtr(label_id: [*c]const u8, values: [*c]const f32, rows: c_int, cols: c_int, scale_min: f64, scale_max: f64, label_fmt: [*c]const u8, bounds_min: ImPlotPoint_c, bounds_max: ImPlotPoint_c, flags: ImPlotHeatmapFlags) void;
pub extern fn ImPlot_PlotHeatmap_doublePtr(label_id: [*c]const u8, values: [*c]const f64, rows: c_int, cols: c_int, scale_min: f64, scale_max: f64, label_fmt: [*c]const u8, bounds_min: ImPlotPoint_c, bounds_max: ImPlotPoint_c, flags: ImPlotHeatmapFlags) void;
pub extern fn ImPlot_PlotHeatmap_S8Ptr(label_id: [*c]const u8, values: [*c]const ImS8, rows: c_int, cols: c_int, scale_min: f64, scale_max: f64, label_fmt: [*c]const u8, bounds_min: ImPlotPoint_c, bounds_max: ImPlotPoint_c, flags: ImPlotHeatmapFlags) void;
pub extern fn ImPlot_PlotHeatmap_U8Ptr(label_id: [*c]const u8, values: [*c]const ImU8, rows: c_int, cols: c_int, scale_min: f64, scale_max: f64, label_fmt: [*c]const u8, bounds_min: ImPlotPoint_c, bounds_max: ImPlotPoint_c, flags: ImPlotHeatmapFlags) void;
pub extern fn ImPlot_PlotHeatmap_S16Ptr(label_id: [*c]const u8, values: [*c]const ImS16, rows: c_int, cols: c_int, scale_min: f64, scale_max: f64, label_fmt: [*c]const u8, bounds_min: ImPlotPoint_c, bounds_max: ImPlotPoint_c, flags: ImPlotHeatmapFlags) void;
pub extern fn ImPlot_PlotHeatmap_U16Ptr(label_id: [*c]const u8, values: [*c]const ImU16, rows: c_int, cols: c_int, scale_min: f64, scale_max: f64, label_fmt: [*c]const u8, bounds_min: ImPlotPoint_c, bounds_max: ImPlotPoint_c, flags: ImPlotHeatmapFlags) void;
pub extern fn ImPlot_PlotHeatmap_S32Ptr(label_id: [*c]const u8, values: [*c]const ImS32, rows: c_int, cols: c_int, scale_min: f64, scale_max: f64, label_fmt: [*c]const u8, bounds_min: ImPlotPoint_c, bounds_max: ImPlotPoint_c, flags: ImPlotHeatmapFlags) void;
pub extern fn ImPlot_PlotHeatmap_U32Ptr(label_id: [*c]const u8, values: [*c]const ImU32, rows: c_int, cols: c_int, scale_min: f64, scale_max: f64, label_fmt: [*c]const u8, bounds_min: ImPlotPoint_c, bounds_max: ImPlotPoint_c, flags: ImPlotHeatmapFlags) void;
pub extern fn ImPlot_PlotHeatmap_S64Ptr(label_id: [*c]const u8, values: [*c]const ImS64, rows: c_int, cols: c_int, scale_min: f64, scale_max: f64, label_fmt: [*c]const u8, bounds_min: ImPlotPoint_c, bounds_max: ImPlotPoint_c, flags: ImPlotHeatmapFlags) void;
pub extern fn ImPlot_PlotHeatmap_U64Ptr(label_id: [*c]const u8, values: [*c]const ImU64, rows: c_int, cols: c_int, scale_min: f64, scale_max: f64, label_fmt: [*c]const u8, bounds_min: ImPlotPoint_c, bounds_max: ImPlotPoint_c, flags: ImPlotHeatmapFlags) void;
pub extern fn ImPlot_PlotHistogram_FloatPtr(label_id: [*c]const u8, values: [*c]const f32, count: c_int, bins: c_int, bar_scale: f64, range: ImPlotRange_c, flags: ImPlotHistogramFlags) f64;
pub extern fn ImPlot_PlotHistogram_doublePtr(label_id: [*c]const u8, values: [*c]const f64, count: c_int, bins: c_int, bar_scale: f64, range: ImPlotRange_c, flags: ImPlotHistogramFlags) f64;
pub extern fn ImPlot_PlotHistogram_S8Ptr(label_id: [*c]const u8, values: [*c]const ImS8, count: c_int, bins: c_int, bar_scale: f64, range: ImPlotRange_c, flags: ImPlotHistogramFlags) f64;
pub extern fn ImPlot_PlotHistogram_U8Ptr(label_id: [*c]const u8, values: [*c]const ImU8, count: c_int, bins: c_int, bar_scale: f64, range: ImPlotRange_c, flags: ImPlotHistogramFlags) f64;
pub extern fn ImPlot_PlotHistogram_S16Ptr(label_id: [*c]const u8, values: [*c]const ImS16, count: c_int, bins: c_int, bar_scale: f64, range: ImPlotRange_c, flags: ImPlotHistogramFlags) f64;
pub extern fn ImPlot_PlotHistogram_U16Ptr(label_id: [*c]const u8, values: [*c]const ImU16, count: c_int, bins: c_int, bar_scale: f64, range: ImPlotRange_c, flags: ImPlotHistogramFlags) f64;
pub extern fn ImPlot_PlotHistogram_S32Ptr(label_id: [*c]const u8, values: [*c]const ImS32, count: c_int, bins: c_int, bar_scale: f64, range: ImPlotRange_c, flags: ImPlotHistogramFlags) f64;
pub extern fn ImPlot_PlotHistogram_U32Ptr(label_id: [*c]const u8, values: [*c]const ImU32, count: c_int, bins: c_int, bar_scale: f64, range: ImPlotRange_c, flags: ImPlotHistogramFlags) f64;
pub extern fn ImPlot_PlotHistogram_S64Ptr(label_id: [*c]const u8, values: [*c]const ImS64, count: c_int, bins: c_int, bar_scale: f64, range: ImPlotRange_c, flags: ImPlotHistogramFlags) f64;
pub extern fn ImPlot_PlotHistogram_U64Ptr(label_id: [*c]const u8, values: [*c]const ImU64, count: c_int, bins: c_int, bar_scale: f64, range: ImPlotRange_c, flags: ImPlotHistogramFlags) f64;
pub extern fn ImPlot_PlotHistogram2D_FloatPtr(label_id: [*c]const u8, xs: [*c]const f32, ys: [*c]const f32, count: c_int, x_bins: c_int, y_bins: c_int, range: ImPlotRect_c, flags: ImPlotHistogramFlags) f64;
pub extern fn ImPlot_PlotHistogram2D_doublePtr(label_id: [*c]const u8, xs: [*c]const f64, ys: [*c]const f64, count: c_int, x_bins: c_int, y_bins: c_int, range: ImPlotRect_c, flags: ImPlotHistogramFlags) f64;
pub extern fn ImPlot_PlotHistogram2D_S8Ptr(label_id: [*c]const u8, xs: [*c]const ImS8, ys: [*c]const ImS8, count: c_int, x_bins: c_int, y_bins: c_int, range: ImPlotRect_c, flags: ImPlotHistogramFlags) f64;
pub extern fn ImPlot_PlotHistogram2D_U8Ptr(label_id: [*c]const u8, xs: [*c]const ImU8, ys: [*c]const ImU8, count: c_int, x_bins: c_int, y_bins: c_int, range: ImPlotRect_c, flags: ImPlotHistogramFlags) f64;
pub extern fn ImPlot_PlotHistogram2D_S16Ptr(label_id: [*c]const u8, xs: [*c]const ImS16, ys: [*c]const ImS16, count: c_int, x_bins: c_int, y_bins: c_int, range: ImPlotRect_c, flags: ImPlotHistogramFlags) f64;
pub extern fn ImPlot_PlotHistogram2D_U16Ptr(label_id: [*c]const u8, xs: [*c]const ImU16, ys: [*c]const ImU16, count: c_int, x_bins: c_int, y_bins: c_int, range: ImPlotRect_c, flags: ImPlotHistogramFlags) f64;
pub extern fn ImPlot_PlotHistogram2D_S32Ptr(label_id: [*c]const u8, xs: [*c]const ImS32, ys: [*c]const ImS32, count: c_int, x_bins: c_int, y_bins: c_int, range: ImPlotRect_c, flags: ImPlotHistogramFlags) f64;
pub extern fn ImPlot_PlotHistogram2D_U32Ptr(label_id: [*c]const u8, xs: [*c]const ImU32, ys: [*c]const ImU32, count: c_int, x_bins: c_int, y_bins: c_int, range: ImPlotRect_c, flags: ImPlotHistogramFlags) f64;
pub extern fn ImPlot_PlotHistogram2D_S64Ptr(label_id: [*c]const u8, xs: [*c]const ImS64, ys: [*c]const ImS64, count: c_int, x_bins: c_int, y_bins: c_int, range: ImPlotRect_c, flags: ImPlotHistogramFlags) f64;
pub extern fn ImPlot_PlotHistogram2D_U64Ptr(label_id: [*c]const u8, xs: [*c]const ImU64, ys: [*c]const ImU64, count: c_int, x_bins: c_int, y_bins: c_int, range: ImPlotRect_c, flags: ImPlotHistogramFlags) f64;
...
pub extern fn ImPlot_PlotImage(label_id: [*c]const u8, tex_ref: ImTextureRef_c, bounds_min: ImPlotPoint_c, bounds_max: ImPlotPoint_c, uv0: ImVec2_c, uv1: ImVec2_c, tint_col: ImVec4_c, flags: ImPlotImageFlags) void;
pub extern fn ImPlot_PlotText(text: [*c]const u8, x: f64, y: f64, pix_offset: ImVec2_c, flags: ImPlotTextFlags) void;
pub extern fn ImPlot_PlotDummy(label_id: [*c]const u8, flags: ImPlotDummyFlags) void;
pub extern fn ImPlot_DragPoint(id: c_int, x: [*c]f64, y: [*c]f64, col: ImVec4_c, size: f32, flags: ImPlotDragToolFlags, out_clicked: [*c]bool, out_hovered: [*c]bool, out_held: [*c]bool) bool;
pub extern fn ImPlot_DragLineX(id: c_int, x: [*c]f64, col: ImVec4_c, thickness: f32, flags: ImPlotDragToolFlags, out_clicked: [*c]bool, out_hovered: [*c]bool, out_held: [*c]bool) bool;
pub extern fn ImPlot_DragLineY(id: c_int, y: [*c]f64, col: ImVec4_c, thickness: f32, flags: ImPlotDragToolFlags, out_clicked: [*c]bool, out_hovered: [*c]bool, out_held: [*c]bool) bool;
pub extern fn ImPlot_DragRect(id: c_int, x1: [*c]f64, y1: [*c]f64, x2: [*c]f64, y2: [*c]f64, col: ImVec4_c, flags: ImPlotDragToolFlags, out_clicked: [*c]bool, out_hovered: [*c]bool, out_held: [*c]bool) bool;
pub extern fn ImPlot_Annotation_Bool(x: f64, y: f64, col: ImVec4_c, pix_offset: ImVec2_c, clamp: bool, round: bool) void;
pub extern fn ImPlot_Annotation_Str(x: f64, y: f64, col: ImVec4_c, pix_offset: ImVec2_c, clamp: bool, fmt: [*c]const u8, ...) void;
pub extern fn ImPlot_AnnotationV(x: f64, y: f64, col: ImVec4_c, pix_offset: ImVec2_c, clamp: bool, fmt: [*c]const u8, args: va_list) void;
pub extern fn ImPlot_TagX_Bool(x: f64, col: ImVec4_c, round: bool) void;
pub extern fn ImPlot_TagX_Str(x: f64, col: ImVec4_c, fmt: [*c]const u8, ...) void;
pub extern fn ImPlot_TagXV(x: f64, col: ImVec4_c, fmt: [*c]const u8, args: va_list) void;
pub extern fn ImPlot_TagY_Bool(y: f64, col: ImVec4_c, round: bool) void;
pub extern fn ImPlot_TagY_Str(y: f64, col: ImVec4_c, fmt: [*c]const u8, ...) void;
pub extern fn ImPlot_TagYV(y: f64, col: ImVec4_c, fmt: [*c]const u8, args: va_list) void;
pub extern fn ImPlot_SetAxis(axis: ImAxis) void;
pub extern fn ImPlot_SetAxes(x_axis: ImAxis, y_axis: ImAxis) void;
pub extern fn ImPlot_PixelsToPlot_Vec2(pix: ImVec2_c, x_axis: ImAxis, y_axis: ImAxis) ImPlotPoint_c;
pub extern fn ImPlot_PixelsToPlot_Float(x: f32, y: f32, x_axis: ImAxis, y_axis: ImAxis) ImPlotPoint_c;
pub extern fn ImPlot_PlotToPixels_PlotPoInt(plt: ImPlotPoint_c, x_axis: ImAxis, y_axis: ImAxis) ImVec2_c;
pub extern fn ImPlot_PlotToPixels_double(x: f64, y: f64, x_axis: ImAxis, y_axis: ImAxis) ImVec2_c;
pub extern fn ImPlot_GetPlotPos() ImVec2_c;
pub extern fn ImPlot_GetPlotSize() ImVec2_c;
pub extern fn ImPlot_GetPlotMousePos(x_axis: ImAxis, y_axis: ImAxis) ImPlotPoint_c;
pub extern fn ImPlot_GetPlotLimits(x_axis: ImAxis, y_axis: ImAxis) ImPlotRect_c;
...
pub extern fn ImPlot_GetPlotSelection(x_axis: ImAxis, y_axis: ImAxis) ImPlotRect_c;
...
pub extern fn ImPlot_PushStyleColor_Vec4(idx: ImPlotCol, col: ImVec4_c) void;
...
pub extern fn ImPlot_PushStyleVar_Vec2(idx: ImPlotStyleVar, val: ImVec2_c) void;
pub extern fn ImPlot_PopStyleVar(count: c_int) void;
pub extern fn ImPlot_SetNextLineStyle(col: ImVec4_c, weight: f32) void;
pub extern fn ImPlot_SetNextFillStyle(col: ImVec4_c, alpha_mod: f32) void;
pub extern fn ImPlot_SetNextMarkerStyle(marker: ImPlotMarker, size: f32, fill: ImVec4_c, weight: f32, outline: ImVec4_c) void;
pub extern fn ImPlot_SetNextErrorBarStyle(col: ImVec4_c, size: f32, weight: f32) void;
pub extern fn ImPlot_GetLastItemColor() ImVec4_c;
...
pub extern fn ImPlot_NextColormapColor() ImVec4_c;
pub extern fn ImPlot_GetColormapSize(cmap: ImPlotColormap) c_int;
pub extern fn ImPlot_GetColormapColor(idx: c_int, cmap: ImPlotColormap) ImVec4_c;
pub extern fn ImPlot_SampleColormap(t: f32, cmap: ImPlotColormap) ImVec4_c;
pub extern fn ImPlot_ColormapScale(label: [*c]const u8, scale_min: f64, scale_max: f64, size: ImVec2_c, format: [*c]const u8, flags: ImPlotColormapScaleFlags, cmap: ImPlotColormap) void;
pub extern fn ImPlot_ColormapSlider(label: [*c]const u8, t: [*c]f32, out: [*c]ImVec4, format: [*c]const u8, cmap: ImPlotColormap) bool;
pub extern fn ImPlot_ColormapButton(label: [*c]const u8, size: ImVec2_c, cmap: ImPlotColormap) bool;
...
pub extern fn ImPlot_ItemIcon_Vec4(col: ImVec4_c) void;
...
pub extern fn ImPlotTime_FromDouble(t: f64) ImPlotTime_c;
...
pub extern fn ImPlotPointError_ImPlotPointError_Nil() [*c]ImPlotPointError;
pub extern fn ImPlotPointError_destroy(self: [*c]ImPlotPointError) void;
pub extern fn ImPlotPointError_ImPlotPointError_double(x: f64, y: f64, neg: f64, pos: f64) [*c]ImPlotPointError;
...
pub extern fn ImPlotAnnotationCollection_AppendV(self: [*c]ImPlotAnnotationCollection, pos: ImVec2_c, off: ImVec2_c, bg: ImU32, fg: ImU32, clamp: bool, fmt: [*c]const u8, args: va_list) void;
pub extern fn ImPlotAnnotationCollection_Append(self: [*c]ImPlotAnnotationCollection, pos: ImVec2_c, off: ImVec2_c, bg: ImU32, fg: ImU32, clamp: bool, fmt: [*c]const u8, ...) void;
...
pub extern fn ImPlotTag_ImPlotTag() [*c]ImPlotTag;
pub extern fn ImPlotTag_destroy(self: [*c]ImPlotTag) void;
...
pub extern fn ImPlotTick_ImPlotTick_Nil() [*c]ImPlotTick;
pub extern fn ImPlotTick_destroy(self: [*c]ImPlotTick) void;
pub extern fn ImPlotTick_ImPlotTick_double(value: f64, major: bool, level: c_int, show_label: bool) [*c]ImPlotTick;
...
pub extern fn ImPlotTicker_AddTick_PlotTick(self: [*c]ImPlotTicker, tick: ImPlotTick_c) [*c]ImPlotTick;
pub extern fn ImPlotTicker_GetText_Int(self: [*c]ImPlotTicker, idx: c_int) [*c]const u8;
pub extern fn ImPlotTicker_GetText_PlotTick(self: [*c]ImPlotTicker, tick: ImPlotTick_c) [*c]const u8;
pub extern fn ImPlotTicker_OverrideSizeLate(self: [*c]ImPlotTicker, size: ImVec2_c) void;
...
pub extern fn ImPlotAxis_SetRange_PlotRange(self: [*c]ImPlotAxis, range: ImPlotRange_c) void;
...
pub extern fn ImPlotPlot_GetAxisLabel(self: [*c]ImPlotPlot, axis: ImPlotAxis_c) [*c]const u8;
...
pub extern fn ImPlot_FitPoint(p: ImPlotPoint_c) void;
pub extern fn ImPlot_RangesOverlap(r1: ImPlotRange_c, r2: ImPlotRange_c) bool;
pub extern fn ImPlot_ShowAxisContextMenu(axis: [*c]ImPlotAxis, equal_axis: [*c]ImPlotAxis, time_allowed: bool) void;
pub extern fn ImPlot_GetLocationPos(outer_rect: ImRect_c, inner_size: ImVec2_c, location: ImPlotLocation, pad: ImVec2_c) ImVec2_c;
pub extern fn ImPlot_CalcLegendSize(items: [*c]ImPlotItemGroup, pad: ImVec2_c, spacing: ImVec2_c, vertical: bool) ImVec2_c;
pub extern fn ImPlot_ClampLegendRect(legend_rect: [*c]ImRect, outer_rect: ImRect_c, pad: ImVec2_c) bool;
pub extern fn ImPlot_ShowLegendEntries(items: [*c]ImPlotItemGroup, legend_bb: ImRect_c, interactable: bool, pad: ImVec2_c, spacing: ImVec2_c, vertical: bool, DrawList: [*c]ImDrawList) bool;
pub extern fn ImPlot_ShowAltLegend(title_id: [*c]const u8, vertical: bool, size: ImVec2_c, interactable: bool) void;
pub extern fn ImPlot_ShowLegendContextMenu(legend: [*c]ImPlotLegend, visible: bool) bool;
pub extern fn ImPlot_LabelAxisValue(axis: ImPlotAxis_c, value: f64, buff: [*c]u8, size: c_int, round: bool) void;
pub extern fn ImPlot_GetItemData() [*c]const ImPlotNextItemData;
pub extern fn ImPlot_IsColorAuto_Vec4(col: ImVec4_c) bool;
pub extern fn ImPlot_IsColorAuto_PlotCol(idx: ImPlotCol) bool;
pub extern fn ImPlot_GetAutoColor(idx: ImPlotCol) ImVec4_c;
pub extern fn ImPlot_GetStyleColorVec4(idx: ImPlotCol) ImVec4_c;
pub extern fn ImPlot_GetStyleColorU32(idx: ImPlotCol) ImU32;
pub extern fn ImPlot_AddTextVertical(DrawList: [*c]ImDrawList, pos: ImVec2_c, col: ImU32, text_begin: [*c]const u8, text_end: [*c]const u8) void;
pub extern fn ImPlot_AddTextCentered(DrawList: [*c]ImDrawList, top_center: ImVec2_c, col: ImU32, text_begin: [*c]const u8, text_end: [*c]const u8) void;
pub extern fn ImPlot_CalcTextSizeVertical(text: [*c]const u8) ImVec2_c;
pub extern fn ImPlot_CalcTextColor_Vec4(bg: ImVec4_c) ImU32;
pub extern fn ImPlot_CalcTextColor_U32(bg: ImU32) ImU32;
pub extern fn ImPlot_CalcHoverColor(col: ImU32) ImU32;
pub extern fn ImPlot_ClampLabelPos(pos: ImVec2_c, size: ImVec2_c, Min: ImVec2_c, Max: ImVec2_c) ImVec2_c;
...
pub extern fn ImPlot_RenderColorBar(colors: [*c]const ImU32, size: c_int, DrawList: [*c]ImDrawList, bounds: ImRect_c, vert: bool, reversed: bool, continuous: bool) void;
...
pub extern fn ImPlot_Intersection(a1: ImVec2_c, a2: ImVec2_c, b1: ImVec2_c, b2: ImVec2_c) ImVec2_c;
...
pub extern fn ImPlot_CalculateBins_FloatPtr(values: [*c]const f32, count: c_int, meth: ImPlotBin, range: ImPlotRange_c, bins_out: [*c]c_int, width_out: [*c]f64) void;
pub extern fn ImPlot_CalculateBins_doublePtr(values: [*c]const f64, count: c_int, meth: ImPlotBin, range: ImPlotRange_c, bins_out: [*c]c_int, width_out: [*c]f64) void;
pub extern fn ImPlot_CalculateBins_S8Ptr(values: [*c]const ImS8, count: c_int, meth: ImPlotBin, range: ImPlotRange_c, bins_out: [*c]c_int, width_out: [*c]f64) void;
pub extern fn ImPlot_CalculateBins_U8Ptr(values: [*c]const ImU8, count: c_int, meth: ImPlotBin, range: ImPlotRange_c, bins_out: [*c]c_int, width_out: [*c]f64) void;
pub extern fn ImPlot_CalculateBins_S16Ptr(values: [*c]const ImS16, count: c_int, meth: ImPlotBin, range: ImPlotRange_c, bins_out: [*c]c_int, width_out: [*c]f64) void;
pub extern fn ImPlot_CalculateBins_U16Ptr(values: [*c]const ImU16, count: c_int, meth: ImPlotBin, range: ImPlotRange_c, bins_out: [*c]c_int, width_out: [*c]f64) void;
pub extern fn ImPlot_CalculateBins_S32Ptr(values: [*c]const ImS32, count: c_int, meth: ImPlotBin, range: ImPlotRange_c, bins_out: [*c]c_int, width_out: [*c]f64) void;
pub extern fn ImPlot_CalculateBins_U32Ptr(values: [*c]const ImU32, count: c_int, meth: ImPlotBin, range: ImPlotRange_c, bins_out: [*c]c_int, width_out: [*c]f64) void;
pub extern fn ImPlot_CalculateBins_S64Ptr(values: [*c]const ImS64, count: c_int, meth: ImPlotBin, range: ImPlotRange_c, bins_out: [*c]c_int, width_out: [*c]f64) void;
pub extern fn ImPlot_CalculateBins_U64Ptr(values: [*c]const ImU64, count: c_int, meth: ImPlotBin, range: ImPlotRange_c, bins_out: [*c]c_int, width_out: [*c]f64) void;
pub extern fn ImPlot_IsLeapYear(year: c_int) bool;
pub extern fn ImPlot_GetDaysInMonth(year: c_int, month: c_int) c_int;
pub extern fn ImPlot_MkGmtTime(ptm: [*c]struct_tm) ImPlotTime_c;
pub extern fn ImPlot_GetGmtTime(t: ImPlotTime_c, ptm: [*c]tm) [*c]tm;
pub extern fn ImPlot_MkLocTime(ptm: [*c]struct_tm) ImPlotTime_c;
pub extern fn ImPlot_GetLocTime(t: ImPlotTime_c, ptm: [*c]tm) [*c]tm;
pub extern fn ImPlot_MkTime(ptm: [*c]struct_tm) ImPlotTime_c;
pub extern fn ImPlot_GetTime(t: ImPlotTime_c, ptm: [*c]tm) [*c]tm;
pub extern fn ImPlot_MakeTime(year: c_int, month: c_int, day: c_int, hour: c_int, min: c_int, sec: c_int, us: c_int) ImPlotTime_c;
pub extern fn ImPlot_GetYear(t: ImPlotTime_c) c_int;
pub extern fn ImPlot_GetMonth(t: ImPlotTime_c) c_int;
pub extern fn ImPlot_AddTime(t: ImPlotTime_c, unit: ImPlotTimeUnit, count: c_int) ImPlotTime_c;
pub extern fn ImPlot_FloorTime(t: ImPlotTime_c, unit: ImPlotTimeUnit) ImPlotTime_c;
pub extern fn ImPlot_CeilTime(t: ImPlotTime_c, unit: ImPlotTimeUnit) ImPlotTime_c;
pub extern fn ImPlot_RoundTime(t: ImPlotTime_c, unit: ImPlotTimeUnit) ImPlotTime_c;
pub extern fn ImPlot_CombineDateTime(date_part: ImPlotTime_c, time_part: ImPlotTime_c) ImPlotTime_c;
pub extern fn ImPlot_Now() ImPlotTime_c;
pub extern fn ImPlot_Today() ImPlotTime_c;
pub extern fn ImPlot_FormatTime(t: ImPlotTime_c, buffer: [*c]u8, size: c_int, fmt: ImPlotTimeFmt, use_24_hr_clk: bool) c_int;
pub extern fn ImPlot_FormatDate(t: ImPlotTime_c, buffer: [*c]u8, size: c_int, fmt: ImPlotDateFmt, use_iso_8601: bool) c_int;
pub extern fn ImPlot_FormatDateTime(t: ImPlotTime_c, buffer: [*c]u8, size: c_int, fmt: ImPlotDateTimeSpec_c) c_int;
...
pub extern fn ImPlot_Locator_Default(ticker: [*c]ImPlotTicker, range: ImPlotRange_c, pixels: f32, vertical: bool, formatter: ImPlotFormatter, formatter_data: ?*anyopaque) void;
pub extern fn ImPlot_Locator_Time(ticker: [*c]ImPlotTicker, range: ImPlotRange_c, pixels: f32, vertical: bool, formatter: ImPlotFormatter, formatter_data: ?*anyopaque) void;
pub extern fn ImPlot_Locator_Log10(ticker: [*c]ImPlotTicker, range: ImPlotRange_c, pixels: f32, vertical: bool, formatter: ImPlotFormatter, formatter_data: ?*anyopaque) void;
pub extern fn ImPlot_Locator_SymLog(ticker: [*c]ImPlotTicker, range: ImPlotRange_c, pixels: f32, vertical: bool, formatter: ImPlotFormatter, formatter_data: ?*anyopaque) void;
...
// C:\imguinz\examples\glfw_opengl3_implot\../../src/libzig/implot\..\..\libc\cimgui/cimgui.h:14:17
...
// C:\imguinz\examples\glfw_opengl3_implot\../../src/libzig/implot\..\..\libc\cimgui/cimgui.h:29:13
pub const CIMGUI_API = EXTERN ++ API;
pub const CONST = @compileError("unable to translate C expr: unexpected token 'const'");
// C:\imguinz\examples\glfw_opengl3_implot\../../src/libzig/implot\..\..\libc\cimgui/cimgui.h:33:9
