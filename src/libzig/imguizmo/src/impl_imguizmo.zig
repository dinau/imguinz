...
// C:\imguinz\examples\glfw_opengl3_imguizmo\../../src/libzig/imguizmo\..\..\libc\cimgui/cimgui.h:1569:18: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_imguizmo\../../src/libzig/imguizmo\..\..\libc\cimgui/cimgui.h:1652:18: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_imguizmo\../../src/libzig/imguizmo\..\..\libc\cimgui/cimgui.h:3777:9: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_imguizmo\../../src/libzig/imguizmo\..\..\libc\cimgui/cimgui.h:3403:29: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_imguizmo\../../src/libzig/imguizmo\..\..\libc\cimgui/cimgui.h:3568:10: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_imguizmo\../../src/libzig/imguizmo\..\..\libc\cimgui/cimgui.h:3631:24: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_imguizmo\../../src/libzig/imguizmo\..\..\libc\cimgui/cimgui.h:2591:19: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_imguizmo\../../src/libzig/imguizmo\..\..\libc\cimgui/cimgui.h:2694:24: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_imguizmo\../../src/libzig/imguizmo\..\..\libc\cimgui/cimgui.h:1937:11: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_imguizmo\../../src/libzig/imguizmo\..\..\libc\cimgui/cimgui.h:3749:10: warning: struct demoted to opaque type - has bitfield
...
pub const TRANSLATE_X: c_int = 1;
pub const TRANSLATE_Y: c_int = 2;
pub const TRANSLATE_Z: c_int = 4;
pub const ROTATE_X: c_int = 8;
pub const ROTATE_Y: c_int = 16;
pub const ROTATE_Z: c_int = 32;
pub const ROTATE_SCREEN: c_int = 64;
pub const SCALE_X: c_int = 128;
pub const SCALE_Y: c_int = 256;
pub const SCALE_Z: c_int = 512;
pub const BOUNDS: c_int = 1024;
pub const SCALE_XU: c_int = 2048;
pub const SCALE_YU: c_int = 4096;
pub const SCALE_ZU: c_int = 8192;
pub const TRANSLATE: c_int = 7;
pub const ROTATE: c_int = 120;
pub const SCALE: c_int = 896;
pub const SCALEU: c_int = 14336;
pub const UNIVERSAL: c_int = 14463;
pub const OPERATION = c_uint;
pub const LOCAL: c_int = 0;
pub const WORLD: c_int = 1;
pub const MODE = c_uint;
pub const DIRECTION_X: c_int = 0;
pub const DIRECTION_Y: c_int = 1;
pub const DIRECTION_Z: c_int = 2;
pub const PLANE_X: c_int = 3;
pub const PLANE_Y: c_int = 4;
pub const PLANE_Z: c_int = 5;
pub const SELECTION: c_int = 6;
pub const INACTIVE: c_int = 7;
pub const TRANSLATION_LINE: c_int = 8;
pub const SCALE_LINE: c_int = 9;
pub const ROTATION_USING_BORDER: c_int = 10;
pub const ROTATION_USING_FILL: c_int = 11;
pub const HATCHED_AXIS_LINES: c_int = 12;
pub const TEXT: c_int = 13;
pub const TEXT_SHADOW: c_int = 14;
pub const COUNT: c_int = 15;
pub const COLOR = c_uint;
pub const struct_Style = extern struct {
    TranslationLineThickness: f32 = @import("std").mem.zeroes(f32),
    TranslationLineArrowSize: f32 = @import("std").mem.zeroes(f32),
    RotationLineThickness: f32 = @import("std").mem.zeroes(f32),
    RotationOuterLineThickness: f32 = @import("std").mem.zeroes(f32),
    ScaleLineThickness: f32 = @import("std").mem.zeroes(f32),
    ScaleLineCircleSize: f32 = @import("std").mem.zeroes(f32),
    HatchedAxisLineThickness: f32 = @import("std").mem.zeroes(f32),
    CenterCircleSize: f32 = @import("std").mem.zeroes(f32),
    Colors: [15]ImVec4 = @import("std").mem.zeroes([15]ImVec4),
};
pub const Style = struct_Style;
pub extern fn ImGuizmo_SetDrawlist(drawlist: [*c]ImDrawList) void;
pub extern fn ImGuizmo_BeginFrame() void;
pub extern fn ImGuizmo_SetImGuiContext(ctx: ?*ImGuiContext) void;
pub extern fn ImGuizmo_IsOver_Nil() bool;
pub extern fn ImGuizmo_IsUsing() bool;
pub extern fn ImGuizmo_IsUsingViewManipulate() bool;
pub extern fn ImGuizmo_IsViewManipulateHovered() bool;
pub extern fn ImGuizmo_IsUsingAny() bool;
pub extern fn ImGuizmo_Enable(enable: bool) void;
pub extern fn ImGuizmo_DecomposeMatrixToComponents(matrix: [*c]const f32, translation: [*c]f32, rotation: [*c]f32, scale: [*c]f32) void;
pub extern fn ImGuizmo_RecomposeMatrixFromComponents(translation: [*c]const f32, rotation: [*c]const f32, scale: [*c]const f32, matrix: [*c]f32) void;
pub extern fn ImGuizmo_SetRect(x: f32, y: f32, width: f32, height: f32) void;
pub extern fn ImGuizmo_SetOrthographic(isOrthographic: bool) void;
pub extern fn ImGuizmo_DrawCubes(view: [*c]const f32, projection: [*c]const f32, matrices: [*c]const f32, matrixCount: c_int) void;
pub extern fn ImGuizmo_DrawGrid(view: [*c]const f32, projection: [*c]const f32, matrix: [*c]const f32, gridSize: f32) void;
pub extern fn ImGuizmo_Manipulate(view: [*c]const f32, projection: [*c]const f32, operation: OPERATION, mode: MODE, matrix: [*c]f32, deltaMatrix: [*c]f32, snap: [*c]const f32, localBounds: [*c]const f32, boundsSnap: [*c]const f32) bool;
pub extern fn ImGuizmo_ViewManipulate_Float(view: [*c]f32, length: f32, position: ImVec2_c, size: ImVec2_c, backgroundColor: ImU32) void;
pub extern fn ImGuizmo_ViewManipulate_FloatPtr(view: [*c]f32, projection: [*c]const f32, operation: OPERATION, mode: MODE, matrix: [*c]f32, length: f32, position: ImVec2_c, size: ImVec2_c, backgroundColor: ImU32) void;
pub extern fn ImGuizmo_SetAlternativeWindow(window: ?*ImGuiWindow) void;
pub extern fn ImGuizmo_SetID(id: c_int) void;
pub extern fn ImGuizmo_PushID_Str(str_id: [*c]const u8) void;
pub extern fn ImGuizmo_PushID_StrStr(str_id_begin: [*c]const u8, str_id_end: [*c]const u8) void;
pub extern fn ImGuizmo_PushID_Ptr(ptr_id: ?*const anyopaque) void;
pub extern fn ImGuizmo_PushID_Int(int_id: c_int) void;
pub extern fn ImGuizmo_PopID() void;
pub extern fn ImGuizmo_GetID_Str(str_id: [*c]const u8) ImGuiID;
pub extern fn ImGuizmo_GetID_StrStr(str_id_begin: [*c]const u8, str_id_end: [*c]const u8) ImGuiID;
pub extern fn ImGuizmo_GetID_Ptr(ptr_id: ?*const anyopaque) ImGuiID;
pub extern fn ImGuizmo_IsOver_OPERATION(op: OPERATION) bool;
pub extern fn ImGuizmo_SetGizmoSizeClipSpace(value: f32) void;
pub extern fn ImGuizmo_AllowAxisFlip(value: bool) void;
pub extern fn ImGuizmo_SetAxisLimit(value: f32) void;
pub extern fn ImGuizmo_SetAxisMask(x: bool, y: bool, z: bool) void;
pub extern fn ImGuizmo_SetPlaneLimit(value: f32) void;
pub extern fn ImGuizmo_IsOver_FloatPtr(position: [*c]f32, pixelRadius: f32) bool;
pub extern fn Style_Style() [*c]Style;
pub extern fn Style_destroy(self: [*c]Style) void;
pub extern fn ImGuizmo_GetStyle() [*c]Style;
...
// C:\imguinz\examples\glfw_opengl3_imguizmo\../../src/libzig/imguizmo\..\..\libc\cimgui/cimgui.h:14:17
...
// C:\imguinz\examples\glfw_opengl3_imguizmo\../../src/libzig/imguizmo\..\..\libc\cimgui/cimgui.h:29:13
pub const CIMGUI_API = EXTERN ++ API;
pub const CONST = @compileError("unable to translate C expr: unexpected token 'const'");
// C:\imguinz\examples\glfw_opengl3_imguizmo\../../src/libzig/imguizmo\..\..\libc\cimgui/cimgui.h:33:9
