...
// C:\imguinz\examples\glfw_opengl3_imguicolortextedit\../../src/libzig/imcolortextedit\..\..\libc\cimgui/cimgui.h:1569:18: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_imguicolortextedit\../../src/libzig/imcolortextedit\..\..\libc\cimgui/cimgui.h:1652:18: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_imguicolortextedit\../../src/libzig/imcolortextedit\..\..\libc\cimgui/cimgui.h:3777:9: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_imguicolortextedit\../../src/libzig/imcolortextedit\..\..\libc\cimgui/cimgui.h:3403:29: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_imguicolortextedit\../../src/libzig/imcolortextedit\..\..\libc\cimgui/cimgui.h:3568:10: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_imguicolortextedit\../../src/libzig/imcolortextedit\..\..\libc\cimgui/cimgui.h:3631:24: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_imguicolortextedit\../../src/libzig/imcolortextedit\..\..\libc\cimgui/cimgui.h:2591:19: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_imguicolortextedit\../../src/libzig/imcolortextedit\..\..\libc\cimgui/cimgui.h:2694:24: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_imguicolortextedit\../../src/libzig/imcolortextedit\..\..\libc\cimgui/cimgui.h:1937:11: warning: struct demoted to opaque type - has bitfield
...
// C:\imguinz\examples\glfw_opengl3_imguicolortextedit\../../src/libzig/imcolortextedit\..\..\libc\cimgui/cimgui.h:3749:10: warning: struct demoted to opaque type - has bitfield
...
pub const struct_TextEditor = extern struct {};
pub const TextEditor = struct_TextEditor;
pub const Dark: c_int = 0;
pub const Light: c_int = 1;
pub const Mariana: c_int = 2;
pub const RetroBlue: c_int = 3;
pub const PaletteId = c_uint;
pub const None: c_int = 0;
pub const Cpp: c_int = 1;
pub const C: c_int = 2;
pub const Cs: c_int = 3;
pub const Python: c_int = 4;
pub const Lua: c_int = 5;
pub const Json: c_int = 6;
pub const Sql: c_int = 7;
pub const AngelScript: c_int = 8;
pub const Glsl: c_int = 9;
pub const Hlsl: c_int = 10;
pub const LanguageDefinitionId = c_uint;
pub const FirstVisibleLine: c_int = 0;
pub const Centered: c_int = 1;
pub const LastVisibleLine: c_int = 2;
pub const SetViewAtLineMode = c_uint;
pub extern fn TextEditor_TextEditor() [*c]TextEditor;
pub extern fn TextEditor_destroy(self: [*c]TextEditor) void;
pub extern fn TextEditor_SetReadOnlyEnabled(self: [*c]TextEditor, aValue: bool) void;
pub extern fn TextEditor_IsReadOnlyEnabled(self: [*c]TextEditor) bool;
pub extern fn TextEditor_SetAutoIndentEnabled(self: [*c]TextEditor, aValue: bool) void;
pub extern fn TextEditor_IsAutoIndentEnabled(self: [*c]TextEditor) bool;
pub extern fn TextEditor_SetShowWhitespacesEnabled(self: [*c]TextEditor, aValue: bool) void;
pub extern fn TextEditor_IsShowWhitespacesEnabled(self: [*c]TextEditor) bool;
pub extern fn TextEditor_SetShowLineNumbersEnabled(self: [*c]TextEditor, aValue: bool) void;
pub extern fn TextEditor_IsShowLineNumbersEnabled(self: [*c]TextEditor) bool;
pub extern fn TextEditor_SetShortTabsEnabled(self: [*c]TextEditor, aValue: bool) void;
pub extern fn TextEditor_IsShortTabsEnabled(self: [*c]TextEditor) bool;
pub extern fn TextEditor_GetLineCount(self: [*c]TextEditor) c_int;
pub extern fn TextEditor_IsOverwriteEnabled(self: [*c]TextEditor) bool;
pub extern fn TextEditor_SetPalette(self: [*c]TextEditor, aValue: PaletteId) void;
pub extern fn TextEditor_GetPalette(self: [*c]TextEditor) PaletteId;
pub extern fn TextEditor_SetLanguageDefinition(self: [*c]TextEditor, aValue: LanguageDefinitionId) void;
pub extern fn TextEditor_GetLanguageDefinition(self: [*c]TextEditor) LanguageDefinitionId;
pub extern fn TextEditor_GetLanguageDefinitionName(self: [*c]TextEditor) [*c]const u8;
pub extern fn TextEditor_SetTabSize(self: [*c]TextEditor, aValue: c_int) void;
pub extern fn TextEditor_GetTabSize(self: [*c]TextEditor) c_int;
pub extern fn TextEditor_SetLineSpacing(self: [*c]TextEditor, aValue: f32) void;
pub extern fn TextEditor_GetLineSpacing(self: [*c]TextEditor) f32;
pub extern fn TextEditor_SetDefaultPalette(aValue: PaletteId) void;
pub extern fn TextEditor_GetDefaultPalette() PaletteId;
pub extern fn TextEditor_SelectAll(self: [*c]TextEditor) void;
pub extern fn TextEditor_SelectLine(self: [*c]TextEditor, aLine: c_int) void;
pub extern fn TextEditor_SelectRegion(self: [*c]TextEditor, aStartLine: c_int, aStartChar: c_int, aEndLine: c_int, aEndChar: c_int) void;
pub extern fn TextEditor_SelectNextOccurrenceOf(self: [*c]TextEditor, aText: [*c]const u8, aTextSize: c_int, aCaseSensitive: bool) void;
pub extern fn TextEditor_SelectAllOccurrencesOf(self: [*c]TextEditor, aText: [*c]const u8, aTextSize: c_int, aCaseSensitive: bool) void;
pub extern fn TextEditor_AnyCursorHasSelection(self: [*c]TextEditor) bool;
pub extern fn TextEditor_AllCursorsHaveSelection(self: [*c]TextEditor) bool;
pub extern fn TextEditor_ClearExtraCursors(self: [*c]TextEditor) void;
pub extern fn TextEditor_ClearSelections(self: [*c]TextEditor) void;
pub extern fn TextEditor_SetCursorPosition(self: [*c]TextEditor, aLine: c_int, aCharIndex: c_int) void;
pub extern fn TextEditor_GetCursorPosition(self: [*c]TextEditor, outLine: [*c]c_int, outColumn: [*c]c_int) void;
pub extern fn TextEditor_GetFirstVisibleLine(self: [*c]TextEditor) c_int;
pub extern fn TextEditor_GetLastVisibleLine(self: [*c]TextEditor) c_int;
pub extern fn TextEditor_SetViewAtLine(self: [*c]TextEditor, aLine: c_int, aMode: SetViewAtLineMode) void;
pub extern fn TextEditor_Copy(self: [*c]TextEditor) void;
pub extern fn TextEditor_Cut(self: [*c]TextEditor) void;
pub extern fn TextEditor_Paste(self: [*c]TextEditor) void;
pub extern fn TextEditor_Undo(self: [*c]TextEditor, aSteps: c_int) void;
pub extern fn TextEditor_Redo(self: [*c]TextEditor, aSteps: c_int) void;
pub extern fn TextEditor_CanUndo(self: [*c]TextEditor) bool;
pub extern fn TextEditor_CanRedo(self: [*c]TextEditor) bool;
pub extern fn TextEditor_GetUndoIndex(self: [*c]TextEditor) c_int;
pub extern fn TextEditor_Render(self: [*c]TextEditor, aTitle: [*c]const u8, aParentIsFocused: bool, aSize: ImVec2_c, aBorder: bool) bool;
pub extern fn TextEditor_UnitTests(self: [*c]TextEditor) void;
pub extern fn TextEditor_SetText(self: [*c]TextEditor, aText: [*c]const u8) void;
pub extern fn TextEditor_GetText_alloc(self: [*c]TextEditor) [*c]u8;
pub extern fn TextEditor_GetText_free(ptr: [*c]u8) void;
pub extern fn TextEditor_GetText_static(self: [*c]TextEditor) [*c]const u8;
pub extern fn TextEditor_GetText(self: [*c]TextEditor) [*c]const u8;
pub extern fn TextEditor_ImGuiDebugPanel(self: [*c]TextEditor, panelName: [*c]const u8) void;
...
// C:\imguinz\examples\glfw_opengl3_imguicolortextedit\../../src/libzig/imcolortextedit\..\..\libc\cimgui/cimgui.h:14:17
...
// C:\imguinz\examples\glfw_opengl3_imguicolortextedit\../../src/libzig/imcolortextedit\..\..\libc\cimgui/cimgui.h:29:13
pub const CIMGUI_API = EXTERN ++ API;
pub const CONST = @compileError("unable to translate C expr: unexpected token 'const'");
// C:\imguinz\examples\glfw_opengl3_imguicolortextedit\../../src/libzig/imcolortextedit\..\..\libc\cimgui/cimgui.h:33:9
